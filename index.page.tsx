  ...
  return (
    <div>
      <HeroContainer>
        ...
        <p>Redfish® is a Foo standard RESTful API designed to deliver simple and secure management for converged, hybridIT and the Software Defined Data Center (SDDC).</p>
