...
![Figure1: Client/service model](figures/fig-1-modelserviceclient.png "Figure1: Service-Client model")

<i><span style="font-size: smaller;">Figure 1: Service-Client model</span></i>
...
- Things a little more interesting like compliance with other standards
  (<a href="https://www.odata.org/" target="_blank">Open Data</a>,
  <a href="https://swagger.io/specification/" target="_blank">Swagger/OpenAPI</a>, etc.).
...
- Surprising things like receiving an "error" message for successful requests.
  Figure 2 shows the successful erasure of a storage logical volume (LUN) whose response contains
  the `error{}` object with a message explaining the success of the operation!
  This type of incongruous response is a consequence of compliance with the
  <a href="https://www.odata.org/" target="_blank">Open Data</a> standard.

![Figure 2: The error contains a success message !](figures/fig2-successerror.png "Figure 2: The error contains a success message !")

<i>Figure2: The error contains a success message !</i>
...
For example, the schema defining the root of the Redfish tree is `#ServiceRoot`. Its full name returned by
`curl -sk https://bmc-ip/redfish/v1 | jq '."@odata.type"'` is: `#ServiceRoot.v1_13_0.ServiceRoot`.
Appended to the `#ServiceRoot` fragment, a version number (`1_13_0`) and then a subtype that, in this specific case, is identical to the main schema.
All schemas are publicly available on the
<a href="https://redfish.dmtf.org/schemas" target="_blank">DMTF website</a>
and, are sometimes included in the service itself (refer to the
[Self Describing Model](#self-describing-model) paragraph below).
Note that schema versions can evolve independently of each other.
...
![Figure 3: source dmtf.org/education](figures/fig3-resourcemap.png "Figure 3: source dmtf.org/education")

<i>Figure 3: Source dmtf.org/education</i>
...
![Figure 4: OEM extension](figures/fig4-oemextensions.png "Figure 4: OEM extension")

<i>Figure 4: OEM extension</i>
...
![Figure 5: HPE Superdome chassis collection](figures/fig5-sdfchassis.png "Figure 5: HPE Superdome chassis collection")

<i>Figure 5: HPE Superdome chassis collection</i>
...
![Figure 6: Universal backplane model](figures/fig6-storagechassis.png "Figure 6: Universal backplane model")

<i>Figure 6: Universal backplane model</i>
...
![Figure 7: Example of inter-dependency in BIOS registry](figures/fig7-registrebios.png "Figure 7: Example of inter-dependency in BIOS registry")

<i>Figure 7: Example of inter-dependency in BIOS registry</i>
...
![Figure 8: Modeling an error message with an argument](figures/fig8-registredesmessagesdebase.png "Figure 8: Modeling an error message with an argument")

<i>Figure 8: Modeling an error message with an argument</i>
...
![Figure 9: Possible operations on the URI and link to schema](figures/fig9-allowheader.png "Figure 9: Possible operations on the URI and link to schema")

<i>Figure 9: Possible operations on the URI and link to schema</i>
...
![Figure 10: Deprecated property](figures/fig10-propertydeprecated.png "Figure 10: Deprecated property")

<i>Figure 10: Deprecated property</i>
