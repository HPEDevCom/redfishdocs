...
seo:
  title: iLO 5 v281 Error messages
toc:
  enable: false
disableLastModified: false
---

# Response message definitions of iLO 5 v2.81

This section is a reference for the defined message registry entries in HPE iLO 5 version 2.81. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
### iLO.2.16.ActionParameterValueNotInList
...
### iLO.2.16.AlertDestinationAssociationError
...
### iLO.2.16.AlertMailFeatureDisabled
...
### iLO.2.16.ApmPowerCapModeInUsed
...
### iLO.2.16.ArrayPropertyAlreadyExists
Duplicate value.
...
### iLO.2.16.ArrayPropertyOutOfBound
...
### iLO.2.16.ArrayPropertyValueBadParam
...
### iLO.2.16.BatteryBackupUnitSettingsDisabled
...
### iLO.2.16.BiosPasswordInfoInvalid
...
### iLO.2.16.BundleUpdateAlreadyInProgress
...
### iLO.2.16.BundleUpdateComponentDownloadFailed
...
### iLO.2.16.BundleUpdateComponentDownloadStatus
...
### iLO.2.16.BundleUpdateComponentInstallationFailed
...
### iLO.2.16.BundleUpdateComponentInstallationStatus
...
### iLO.2.16.BundleUpdateInstallSetCreationFailed
...
### iLO.2.16.BundleUpdateInstallSetCreationSuccess
...
### iLO.2.16.BundleUpdateInstallSetMetaDownloadFailed
...
### iLO.2.16.BundleUpdateInstallSetMetaDownloadStatus
...
### iLO.2.16.BundleUpdateInstallSetMetaProcessingFailed
...
### iLO.2.16.BundleUpdateInstallSetMetaProcessingSuccess
...
### iLO.2.16.BundleUpdateInvalidUrl
...
### iLO.2.16.CannotRemoveDefaultLanguagePack
...
### iLO.2.16.CannotRemoveLanguagePack
...
### iLO.2.16.ChassisPowerDataUnAvailable
...
### iLO.2.16.ComponentUploadAlreadyInProgress
A component upload operation is already in progress.
...
### iLO.2.16.ComponentUploadFailed
...
### iLO.2.16.DailyUpdateLimitExceeded
...
### iLO.2.16.DemoLicenseKeyPreviouslyInstalled
...
### iLO.2.16.DeniedHPEOneViewUserCreation
...
### iLO.2.16.DiagsTestAlreadyRunning
...
### iLO.2.16.DowngradePolicyAlreadySet
...
### iLO.2.16.ESKMServersNotConfigured
...
### iLO.2.16.ESXioOrTarImageDownloadAlreadyInProgress
...
### iLO.2.16.EventSubscriptionModified
...
### iLO.2.16.EventSubscriptionRemoved
...
### iLO.2.16.FWFlashSuccessTPMOverrideEnabled
...
### iLO.2.16.FWFlashSuccessTrustedModuleOverrideEnabled
...
### iLO.2.16.FWFlashTPMOverrideFlagRequired
...
### iLO.2.16.FWFlashTrustedModuleOverrideFlagRequired
...
### iLO.2.16.FirmwareFlashAlreadyInProgress
...
### iLO.2.16.FirmwareVersionNotSupported
...
### iLO.2.16.GeneratingCertificate
...
### iLO.2.16.HardDriveZoneBackupFailure
...
### iLO.2.16.IPv6ConfigurationError
...
### iLO.2.16.ImportCertSuccessfuliLOResetinProgress
...
### iLO.2.16.ImportCertificateFailed
...
### iLO.2.16.IndicatorLedInvalidStateChange
...
### iLO.2.16.InterfaceDisabledResetRequired
...
### iLO.2.16.InternalErrorWithParam
The operation was not successful due to an internal service error (shown), but the service is still operational.
...
### iLO.2.16.InvalidConfigurationSpecified
The specified configuration is not valid.
...
### iLO.2.16.InvalidConfigurationSpecifiedForFederation
...
### iLO.2.16.InvalidOperationForAutoPowerOnState
...
### iLO.2.16.InvalidOperationForSystemState
...
### iLO.2.16.InvalidPassphraseLength
...
### iLO.2.16.InvalidPasswordComplexity
...
### iLO.2.16.InvalidPasswordLength
...
### iLO.2.16.InvalidSerialNumberLength
...
### iLO.2.16.InvalidUserDefAlertType
...
### iLO.2.16.InvalidUserDefSensorNumber
...
### iLO.2.16.InvalidUserDefTemperatureThresholdValue
...
### iLO.2.16.LicenseKeyNotSupported
...
### iLO.2.16.LoginAttemptDelayedSeconds
The login was not successful, so the service enforces a delay before another login is allowed.
...
### iLO.2.16.MCTPDiscoveryDisabled
...
### iLO.2.16.MaxVirtualMediaConnectionEstablished
...
### iLO.2.16.MembistVariablesNotSupported
...
### iLO.2.16.MemoryInterleaveSetError
...
### iLO.2.16.NoSNMPAlertDestinationsConfigured
...
### iLO.2.16.NoScriptedVirtualMediaConnectionAvailable
...
### iLO.2.16.NoVirtualMediaConnectionAvailable
...
### iLO.2.16.NodeAssignedCrossRegion
...
### iLO.2.16.NonPLDMUpdateableTargetURI
...
### iLO.2.16.OperationAvailableAfterSystemPOST
...
### iLO.2.16.OperationWillCompleteAfterSystemPOST
...
### iLO.2.16.PowerLimitMayNotTakeEffect
...
### iLO.2.16.PowerRegulationNotDisable
...
### iLO.2.16.PowerSettingAdjustRequired
...
### iLO.2.16.PowerValueInvalidCalibrationData
...
### iLO.2.16.PowerValueUnAvailable
...
### iLO.2.16.PowerValueUnSupported
...
### iLO.2.16.PrimaryESKMServerAccessible
...
### iLO.2.16.PrimarySecondaryAddressesResolveToSameServer
...
### iLO.2.16.PrimarySecondaryESKMServersAccessible
...
### iLO.2.16.PropertyNotWritableOrUnknown
...
### iLO.2.16.PropertyValueAlreadySet
...
### iLO.2.16.PropertyValueBadParam
The property value is not valid.
...
### iLO.2.16.PropertyValueExceedsMaxLength
The value for the property exceeds the maximum length.
...
### iLO.2.16.PropertyValueIncompatible
The value for the property is the correct type, but this value is incompatible with the current value of another property.
...
### iLO.2.16.PropertyValueOutOfRange
The value for the property is out of range.
...
### iLO.2.16.PropertyValueRequired
...
### iLO.2.16.RecoveryInstallSetRequired
...
### iLO.2.16.RequiredPropertyMissing
...
### iLO.2.16.ResourceInUseWithDetail
...
### iLO.2.16.ResourceNotReadyRetry
The resource is present but is not ready to perform operations due to an internal condition such as initialization or reset.
...
### iLO.2.16.ResourceTemporarilyUnavailable
...
### iLO.2.16.SNTPConfigurationManagedByDHCPAndIsReadOnly
...
### iLO.2.16.SSOCertificateReadError
...
### iLO.2.16.SecondaryESKMServerAccessible
...
### iLO.2.16.ServerConfigLockStatusUnknown
...
### iLO.2.16.ServerConfigurationLockEnabled
...
### iLO.2.16.SimpleUpdateInvalidImageOrCredentials
...
### iLO.2.16.SimpleUpdateInvalidImageURI
...
### iLO.2.16.SimpleUpdateInvalidTargetsURI
...
### iLO.2.16.SyslogFeatureDisabled
...
### iLO.2.16.SystemPowerOffRequired
...
### iLO.2.16.SystemPowerStateChangeFailed
...
### iLO.2.16.UnableToModifyAfterVirtualMediaInsert
...
### iLO.2.16.UnableToModifyDueToMissingComponent
...
### iLO.2.16.UnableToModifyDuringSystemPOST
...
### iLO.2.16.UnableToModifyWhileKVMIPConnected
...
### iLO.2.16.UnauthorizedLoginAttempt
...
### iLO.2.16.UnsupportedCipherAlgo
...
### iLO.2.16.UnsupportedOperationACEEnabled
...
### iLO.2.16.UnsupportedOperationInChassisVersion
...
### iLO.2.16.UnsupportedOperationInLegacyBootMode
...
### iLO.2.16.UnsupportedOperationInSystemBIOS
...
### iLO.2.16.UnsupportedSecurityState
...
### iLO.2.16.UpdateDependencyFailure
...
### iLO.2.16.UpdateRepositoryUnavailable
...
### iLO.2.16.UpdateTaskQueueWriteError
...
### iLO.2.16.UpdateTemporarilyUnavailable
...
### iLO.2.16.UserNameAlreadyExists
...
### iLO.2.16.VirtualMediaIsDisabled
...
### iLO.2.16.ZonePowerLimitExceeded
...
### iLO.2.16.iLOResetAndSystemRebootRequired
...
### iLO.2.16.iLOVirtualNICDisabled
