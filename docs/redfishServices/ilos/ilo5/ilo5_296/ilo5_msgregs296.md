...
seo:
  title: iLO 5 v296 Error messages
toc:
  enable: false
disableLastModified: false
---

# Response message definitions of iLO 5 v2.96

This section is a reference for the defined message registry entries in HPE iLO 5 version 2.96. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
