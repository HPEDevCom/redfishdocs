...
# Other resource definitions of iLO 5 v3.06
...
|---|---|
|`Accounts`|Collection of [ManagerAccount](ilo5_manager_resourcedefns306/#manageraccountcollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[BootOption](ilo5_other_resourcedefns306/#bootoption)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Certificate](ilo5_other_resourcedefns306/#certificate)|
...
|Link Name|Destination type|
|---|---|
|`Links/CertificateLocations`|[CertificateLocations](ilo5_other_resourcedefns306/#certificatelocations)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[EventDestination](ilo5_other_resourcedefns306/#eventdestination)|
...
|Link Name|Destination type|
|---|---|
|`Subscriptions`|Collection of [EventDestination](ilo5_other_resourcedefns306/#eventdestinationcollection)|
|`Oem/Hpe/CACertificates`|Collection of [HpeCertificate](ilo5_hpe_resourcedefns306/#hpecertificatecollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Fabric](ilo5_other_resourcedefns306/#fabric)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HostInterface](ilo5_other_resourcedefns306/#hostinterface)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[JsonSchemaFile](ilo5_other_resourcedefns306/#jsonschemafile)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[LogEntry](ilo5_other_resourcedefns306/#logentry)|
...
|Link Name|Destination type|
|---|---|
|`Entries`|Collection of [LogEntry](ilo5_other_resourcedefns306/#logentrycollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[LogService](ilo5_other_resourcedefns306/#logservice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MemoryChunks](ilo5_other_resourcedefns306/#memorychunks)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Memory](ilo5_other_resourcedefns306/#memory)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MemoryDomain](ilo5_other_resourcedefns306/#memorydomain)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MessageRegistryFile](ilo5_other_resourcedefns306/#messageregistryfile)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricDefinition](ilo5_other_resourcedefns306/#metricdefinition)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricReport](ilo5_other_resourcedefns306/#metricreport)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricReportDefinition](ilo5_other_resourcedefns306/#metricreportdefinition)|
...
|Link Name|Destination type|
|---|---|
|`PCIeFunctions`|[PCIeFunction](ilo5_other_resourcedefns306/#pciefunction)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[PCIeDevice](ilo5_other_resourcedefns306/#pciedevice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[PCIeFunction](ilo5_other_resourcedefns306/#pciefunction)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Port](ilo5_other_resourcedefns306/#port)|
...
|Link Name|Destination type|
|---|---|
|`Oem/Hpe/Links/FederatedGroupCapping`|[HpeiLOFederatedGroupCapping](ilo5_hpe_resourcedefns306/#hpeilofederatedgroupcapping)|
|`Oem/Hpe/Links/PowerMeter`|[HpePowerMeter](ilo5_hpe_resourcedefns306/#hpepowermeter)|
|`Redundancy[]/RedundancySet[]`|[Power](ilo5_other_resourcedefns306/#power)|
|`Oem/Hpe/Links/FastPowerMeter`|[HpePowerMeter](ilo5_hpe_resourcedefns306/#hpepowermeter)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Processor](ilo5_other_resourcedefns306/#processor)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Role](ilo5_other_resourcedefns306/#role)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[SerialInterface](ilo5_other_resourcedefns306/#serialinterface)|
...
|Link Name|Destination type|
|---|---|
|`Oem/Hpe/Links/MySession`|[Session](ilo5_other_resourcedefns306/#session)|
|`Members[]`|[Session](ilo5_other_resourcedefns306/#session)|
...
|Link Name|Destination type|
|---|---|
|`Sessions`|Collection of [Session](ilo5_other_resourcedefns306/#sessioncollection)|
...
|Link Name|Destination type|
|---|---|
|`@Redfish.Settings/SettingsObject`|[SmartStorageConfig](ilo5_other_resourcedefns306/#smartstorageconfig)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[SoftwareInventory](ilo5_other_resourcedefns306/#softwareinventory)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|Collection of [Port](ilo5_other_resourcedefns306/#portcollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Task](ilo5_other_resourcedefns306/#task)|
...
|Link Name|Destination type|
|---|---|
|`Tasks`|Collection of [Task](ilo5_other_resourcedefns306/#taskcollection)|
...
|Link Name|Destination type|
|---|---|
|`MetricReports`|Collection of [MetricReport](ilo5_other_resourcedefns306/#metricreportcollection)|
|`MetricReportDefinitions`|Collection of [MetricDefinition](ilo5_other_resourcedefns306/#metricdefinitioncollection)|
|`Triggers`|Collection of [Triggers](ilo5_other_resourcedefns306/#triggerscollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Triggers](ilo5_other_resourcedefns306/#triggers)|
...
|Link Name|Destination type|
|---|---|
|`Oem/Hpe/InstallSets`|Collection of [HpeComponentInstallSet](ilo5_hpe_resourcedefns306/#hpecomponentinstallsetcollection)|
|`Oem/Hpe/ComponentRepository`|Collection of [HpeComponent](ilo5_hpe_resourcedefns306/#hpecomponentcollection)|
|`FirmwareInventory`|Collection of [SoftwareInventory](ilo5_other_resourcedefns306/#softwareinventorycollection)|
|`SoftwareInventory`|Collection of [SoftwareInventory](ilo5_other_resourcedefns306/#softwareinventorycollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[VirtualMedia](ilo5_other_resourcedefns306/#virtualmedia)|
