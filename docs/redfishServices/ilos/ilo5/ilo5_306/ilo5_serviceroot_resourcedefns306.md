...
# Serviceroot resource definitions of iLO 5 v3.06
...
|---|---|
|`Registries`|Collection of [MessageRegistryFile](ilo5_other_resourcedefns306/#messageregistryfilecollection)|
|`Managers`|Collection of [Manager](ilo5_manager_resourcedefns306/#managercollection)|
|`AccountService`|[AccountService](ilo5_other_resourcedefns306/#accountservice)|
|`JsonSchemas`|Collection of [JsonSchemaFile](ilo5_other_resourcedefns306/#jsonschemafilecollection)|
|`UpdateService`|[UpdateService](ilo5_other_resourcedefns306/#updateservice)|
|`Oem/Hpe/Links/ResourceDirectory`|[HpeiLOResourceDirectory](ilo5_hpe_resourcedefns306/#hpeiloresourcedirectory)|
|`SessionService`|[SessionService](ilo5_other_resourcedefns306/#sessionservice)|
|`EventService`|[EventService](ilo5_other_resourcedefns306/#eventservice)|
|`Chassis`|Collection of [Chassis](ilo5_chassis_resourcedefns306/#chassiscollection)|
|`Systems`|Collection of [ComputerSystem](ilo5_computersystem_resourcedefns306/#computersystemcollection)|
|`Links/Sessions`|Collection of [Session](ilo5_other_resourcedefns306/#sessioncollection)|
