...
seo:
  title: iLO 5 v306 Error messages
markdown:
  toc:
    hide: false
    depth: 2
...
# Response message definitions of iLO 5 v3.06

This section is a reference for the defined message registry entries in HPE iLO 5 version 3.06. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
