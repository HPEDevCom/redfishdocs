...
seo:
  title: iLO 5 v278 Error messages
toc:
  enable: false
disableLastModified: false
---

# Response message definitions of iLO 5 v2.78

This section is a reference for the defined message registry entries in HPE iLO 5 version 2.78. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
