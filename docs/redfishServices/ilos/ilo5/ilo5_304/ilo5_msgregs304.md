...
seo:
  title: iLO 5 v304 Error messages
markdown:
  toc:
    hide: false
    depth: 2
...
# Response message definitions of iLO 5 v3.04

This section is a reference for the defined message registry entries in HPE iLO 5 version 3.04. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
### iLO.2.23.ActionParameterValueNotInList
...
### iLO.2.23.ApmPowerCapModeInUsed
...
### iLO.2.23.BatteryBackupUnitSettingsDisabled
...
### iLO.2.23.BundleUpdateComponentDownloadFailed
...
### iLO.2.23.BundleUpdateInstallSetCreationSuccess
...
### iLO.2.23.BundleUpdateInvalidUrl
...
### iLO.2.23.ChassisPowerDataUnAvailable
...
### iLO.2.23.DemoLicenseKeyPreviouslyInstalled
...
### iLO.2.23.FWFlashTrustedModuleOverrideFlagRequired
...
### iLO.2.23.IndicatorLedInvalidStateChange
...
### iLO.2.23.InvalidConfigurationSpecifiedForFederation
...
### iLO.2.23.InvalidOperationForSystemState
...
### iLO.2.23.LicenseKeyNotSupported
...
### iLO.2.23.MCTPDiscoveryDisabled
...
### iLO.2.23.MemoryInterleaveSetError
...
### iLO.2.23.NoVirtualMediaConnectionAvailable
...
### iLO.2.23.PrimaryESKMServerAccessible
...
### iLO.2.23.PropertyValueAlreadySet
...
### iLO.2.23.PropertyValueRequired
...
### iLO.2.23.SimpleUpdateInvalidImageOrCredentials
...
### iLO.2.23.SyslogFeatureDisabled
...
### iLO.2.23.UnableToModifyWhileKVMIPConnected
...
### iLO.2.23.UnsupportedOperationInChassisVersion
...
### iLO.2.23.iLOResetAndSystemRebootRequired
...
### iLOSecurityEvents.1.1.GlobalComponentIntegrityAtIgnore
...
### iLOSecurityEvents.1.1.IPMIOverLANAtOK
...
### iLOSecurityEvents.1.1.IPMIOverLANAtRisk
...
### iLOSecurityEvents.1.1.LastFWScanAtIgnore
...
### iLOSecurityEvents.1.1.LastFWScanAtOK
...
### iLOSecurityEvents.1.1.LastFWScanAtRisk
...
### iLOSecurityEvents.1.1.LogAuthFailureAtIgnore
...
### iLOSecurityEvents.1.1.LogAuthFailureAtOK
...
### iLOSecurityEvents.1.1.LogAuthFailureAtRisk
...
### iLOSecurityEvents.1.1.MinPasswordLengthAtIgnore
...
### iLOSecurityEvents.1.1.MinPasswordLengthAtOK
...
### iLOSecurityEvents.1.1.MinPasswordLengthAtRisk
...
### iLOSecurityEvents.1.1.OverallSecAtIgnore
...
### iLOSecurityEvents.1.1.OverallSecAtOK
...
### iLOSecurityEvents.1.1.OverallSecAtRisk
...
### iLOSecurityEvents.1.1.PasswordComplexityAtIgnore
...
### iLOSecurityEvents.1.1.PasswordComplexityAtOK
...
### iLOSecurityEvents.1.1.PasswordComplexityAtRisk
...
### iLOSecurityEvents.1.1.RBSULoginRequiredAtIgnore
...
### iLOSecurityEvents.1.1.RBSULoginRequiredAtOK
...
### iLOSecurityEvents.1.1.RBSULoginRequiredAtRisk
...
### iLOSecurityEvents.1.1.RequireHostAuthAtIgnore
...
### iLOSecurityEvents.1.1.RequireHostAuthAtOK
...
### iLOSecurityEvents.1.1.RequireHostAuthAtRisk
...
### iLOSecurityEvents.1.1.SNMPv1AtIgnore
...
### iLOSecurityEvents.1.1.SNMPv1AtOK
...
### iLOSecurityEvents.1.1.SNMPv1AtRisk
...
### iLOSecurityEvents.1.1.SecOverrideSwitchAtIgnore
...
### iLOSecurityEvents.1.1.SecOverrideSwitchAtOK
...
### iLOSecurityEvents.1.1.SecOverrideSwitchAtRisk
...
### iLOSecurityEvents.1.1.SecureBootAtIgnore
...
### iLOSecurityEvents.1.1.SecureBootAtOK
...
### iLOSecurityEvents.1.1.SecureBootAtRisk
...
### iLOSecurityEvents.1.1.WeakCipherDisabled
...
### iLOSecurityEvents.1.1.WeakCipherEnabled
