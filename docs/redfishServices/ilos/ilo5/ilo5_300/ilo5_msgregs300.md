...
seo:
  title: iLO 5 v300 Error messages
toc:
  enable: false
disableLastModified: false
---

# Response message definitions of iLO 5 v3.00

This section is a reference for the defined message registry entries in HPE iLO 5 version 3.00. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
