...
seo:
  title: iLO 5 v297 Error messages
toc:
  enable: false
disableLastModified: false
---

# Response message definitions of iLO 5 v2.97

This section is a reference for the defined message registry entries in HPE iLO 5 version 2.97. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
### iLO.2.20.ActionParameterValueNotInList
...
### iLO.2.20.AddFromUriInvalidTargetsURI
The Targets URI passed for the add from uri for firmware image download is not valid.
...
### iLO.2.20.AlertDestinationAssociationError
...
### iLO.2.20.AlertMailFeatureDisabled
...
### iLO.2.20.ApmPowerCapModeInUsed
...
### iLO.2.20.ArrayPropertyAlreadyExists
Duplicate value.
...
### iLO.2.20.ArrayPropertyOutOfBound
...
### iLO.2.20.ArrayPropertyValueBadParam
...
### iLO.2.20.AuthenticationTokenExpired
...
### iLO.2.20.BatteryBackupUnitSettingsDisabled
...
### iLO.2.20.BiosPasswordInfoInvalid
...
### iLO.2.20.BundleUpdateAlreadyInProgress
...
### iLO.2.20.BundleUpdateComponentDownloadFailed
...
### iLO.2.20.BundleUpdateComponentDownloadStatus
...
### iLO.2.20.BundleUpdateComponentInstallationFailed
...
### iLO.2.20.BundleUpdateComponentInstallationStatus
...
### iLO.2.20.BundleUpdateInstallSetCreationFailed
...
### iLO.2.20.BundleUpdateInstallSetCreationSuccess
...
### iLO.2.20.BundleUpdateInstallSetMetaDownloadFailed
...
### iLO.2.20.BundleUpdateInstallSetMetaDownloadStatus
...
### iLO.2.20.BundleUpdateInstallSetMetaProcessingFailed
...
### iLO.2.20.BundleUpdateInstallSetMetaProcessingSuccess
...
### iLO.2.20.BundleUpdateInvalidUrl
...
### iLO.2.20.BundleUpdateResetComplete
...
### iLO.2.20.BundleUpdateResetFailed
...
### iLO.2.20.BundleUpdateResetPending
...
### iLO.2.20.CannotRemoveDefaultLanguagePack
...
### iLO.2.20.CannotRemoveLanguagePack
...
### iLO.2.20.ChassisPowerDataUnAvailable
...
### iLO.2.20.ComponentUploadAlreadyInProgress
A component upload operation is already in progress.
...
### iLO.2.20.ComponentUploadFailed
...
### iLO.2.20.DailyUpdateLimitExceeded
...
### iLO.2.20.DemoLicenseKeyPreviouslyInstalled
...
### iLO.2.20.DeniedHPEOneViewUserCreation
...
### iLO.2.20.DiagsTestAlreadyRunning
...
### iLO.2.20.DowngradePolicyAlreadySet
...
### iLO.2.20.ESKMServersNotConfigured
...
### iLO.2.20.ESXioOrTarImageDownloadAlreadyInProgress
...
### iLO.2.20.EventSubscriptionModified
...
### iLO.2.20.EventSubscriptionRemoved
...
### iLO.2.20.FWFlashSuccessTPMOverrideEnabled
...
### iLO.2.20.FWFlashSuccessTrustedModuleOverrideEnabled
...
### iLO.2.20.FWFlashTPMOverrideFlagRequired
...
### iLO.2.20.FWFlashTrustedModuleOverrideFlagRequired
...
### iLO.2.20.FirmwareFlashAlreadyInProgress
...
### iLO.2.20.FirmwareVersionNotSupported
...
### iLO.2.20.GeneratingCertificate
...
### iLO.2.20.HardDriveZoneBackupFailure
...
### iLO.2.20.IPv6ConfigurationError
...
### iLO.2.20.ImportCertFailCSRMissing
...
### iLO.2.20.ImportCertSuccessfuliLOResetinProgress
...
### iLO.2.20.ImportCertificateFailed
...
### iLO.2.20.IndicatorLedInvalidStateChange
...
### iLO.2.20.InstallSetCreateInvalidTargetsURI
The Targets URI passed for the install set create is not valid.

| | |
|:---|:---|
|Message Format|"The Targets URI %1 posted in install set create is not valid."
|Severity|Warning
|Resolution|Targets URI is incorrect. Provide a valid Targets URI and resubmit the request.

### iLO.2.20.InstallSetWriteError
...
### iLO.2.20.InterfaceDisabledResetRequired
...
### iLO.2.20.InternalErrorWithParam
The operation was not successful due to an internal service error (shown), but the service is still operational.
...
### iLO.2.20.InvalidConfigurationSpecified
The specified configuration is not valid.
...
### iLO.2.20.InvalidConfigurationSpecifiedForFederation
...
### iLO.2.20.InvalidOperationForAutoPowerOnState
...
### iLO.2.20.InvalidOperationForSystemState
...
### iLO.2.20.InvalidPassphraseLength
...
### iLO.2.20.InvalidPasswordComplexity
...
### iLO.2.20.InvalidPasswordLength
...
### iLO.2.20.InvalidSerialNumberLength
...
### iLO.2.20.InvalidUserDefAlertType
...
### iLO.2.20.InvalidUserDefSensorNumber
...
### iLO.2.20.InvalidUserDefTemperatureThresholdValue
...
### iLO.2.20.LicenseKeyNotSupported
...
### iLO.2.20.LocationIndicatorActiveInvalidStateChange
...
### iLO.2.20.LoginAttemptDelayedSeconds
The login was not successful, so the service enforces a delay before another login is allowed.
...
### iLO.2.20.MCTPDiscoveryDisabled
...
### iLO.2.20.MaxVirtualMediaConnectionEstablished
...
### iLO.2.20.MembistVariablesNotSupported
...
### iLO.2.20.MemoryInterleaveSetError
...
### iLO.2.20.NoSNMPAlertDestinationsConfigured
...
### iLO.2.20.NoScriptedVirtualMediaConnectionAvailable
...
### iLO.2.20.NoVirtualMediaConnectionAvailable
...
### iLO.2.20.NodeAssignedCrossRegion
...
### iLO.2.20.NonPLDMUpdateableTargetURI
...
### iLO.2.20.OperationAvailableAfterSystemPOST
...
### iLO.2.20.OperationWillCompleteAfterSystemPOST
...
### iLO.2.20.PowerLimitMayNotTakeEffect
...
### iLO.2.20.PowerRegulationNotDisable
...
### iLO.2.20.PowerSettingAdjustRequired
...
### iLO.2.20.PowerValueInvalidCalibrationData
...
### iLO.2.20.PowerValueUnAvailable
...
### iLO.2.20.PowerValueUnSupported
...
### iLO.2.20.PrimaryESKMServerAccessible
...
### iLO.2.20.PrimarySecondaryAddressesResolveToSameServer
...
### iLO.2.20.PrimarySecondaryESKMServersAccessible
...
### iLO.2.20.PropertyNotWritableOrUnknown
...
### iLO.2.20.PropertyValueAlreadySet
...
### iLO.2.20.PropertyValueBadParam
The property value is not valid.
...
### iLO.2.20.PropertyValueExceedsMaxLength
The value for the property exceeds the maximum length.
...
### iLO.2.20.PropertyValueIncompatible
The value for the property is the correct type, but this value is incompatible with the current value of another property.
...
### iLO.2.20.PropertyValueOutOfRange
The value for the property is out of range.
...
### iLO.2.20.PropertyValueRequired
...
### iLO.2.20.RecoveryInstallSetRequired
...
### iLO.2.20.RequiredPropertyMissing
...
### iLO.2.20.ResourceInUseWithDetail
...
### iLO.2.20.ResourceNotReadyRetry
The resource is present but is not ready to perform operations due to an internal condition such as initialization or reset.
...
### iLO.2.20.ResourceTemporarilyUnavailable
...
### iLO.2.20.SNTPConfigurationManagedByDHCPAndIsReadOnly
...
### iLO.2.20.SSOCertificateReadError
...
### iLO.2.20.SecondaryESKMServerAccessible
...
### iLO.2.20.ServerConfigLockStatusUnknown
...
### iLO.2.20.ServerConfigurationLockEnabled
...
### iLO.2.20.SimpleUpdateInvalidImageOrCredentials
...
### iLO.2.20.SimpleUpdateInvalidImageURI
...
### iLO.2.20.SimpleUpdateInvalidTargetsURI
...
### iLO.2.20.SyslogFeatureDisabled
...
### iLO.2.20.SystemPowerOffRequired
...
### iLO.2.20.SystemPowerStateChangeFailed
...
### iLO.2.20.UnableToModifyAfterVirtualMediaInsert
...
### iLO.2.20.UnableToModifyDueToMissingComponent
...
### iLO.2.20.UnableToModifyDuringSystemPOST
...
### iLO.2.20.UnableToModifyWhileKVMIPConnected
...
### iLO.2.20.UnauthorizedLoginAttempt
...
### iLO.2.20.UnsupportedCipherAlgo
...
### iLO.2.20.UnsupportedOperationACEEnabled
...
### iLO.2.20.UnsupportedOperationInChassisVersion
...
### iLO.2.20.UnsupportedOperationInLegacyBootMode
...
### iLO.2.20.UnsupportedOperationInSystemBIOS
...
### iLO.2.20.UnsupportedSecurityState
...
### iLO.2.20.UpdateDependencyFailure
...
### iLO.2.20.UpdateRepositoryUnavailable
...
### iLO.2.20.UpdateTaskQueueWriteError
...
### iLO.2.20.UpdateTemporarilyUnavailable
...
### iLO.2.20.UserNameAlreadyExists
...
### iLO.2.20.VirtualMediaIsDisabled
...
### iLO.2.20.ZonePowerLimitExceeded
...
### iLO.2.20.iLOResetAndSystemRebootRequired
...
### iLO.2.20.iLOVirtualNICDisabled
...
### TaskEvent.1.1.TaskCompletedWarning
...
### TaskEvent.1.1.TaskProgessChanged
