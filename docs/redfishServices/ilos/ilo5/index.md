...
This section contains the complete history of modifications starting with firmware version 1.40.
...
Only the last five firmware versions are present in this section.
{% /admonition %}
