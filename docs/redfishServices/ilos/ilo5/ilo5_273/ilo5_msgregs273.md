...
seo:
  title: iLO 5 v273 Error messages
markdown:
  toc:
    hide: false
    depth: 2
...
# Response message definitions of iLO 5 v2.73

This section is a reference for the defined message registry entries in HPE iLO 5 version 2.73. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
