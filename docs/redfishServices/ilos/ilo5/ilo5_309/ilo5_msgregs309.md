...
This section is a reference for the defined message registry entries in HPE iLO 5 version 3.09. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
### iLO.2.25.FirmwareVersionNotSupported
...
### iLO.2.25.UnsupportedOperationWeakCipherDisabled
