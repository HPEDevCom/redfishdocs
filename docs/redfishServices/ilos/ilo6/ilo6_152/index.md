---
seo:
  title: HPE iLO 6 v1.52 reference documents
disableLastModified: true
toc:
   enable: false
---

# HPE iLO 6 v1.52 reference documents overview

HPE iLO Redfish reference documents consist of three documents bound to a specific iLO firmware version:

- [Resource map](/docs/redfishservices/ilos/ilo6/ilo6_152/ilo6_resmap152/)
- Resource definitions (i.e. [ServiceRoot](/docs/redfishservices/ilos/ilo6/ilo6_152/ilo6_serviceroot_resourcedefns152/))
- [Error messages](/docs/redfishservices/ilos/ilo6/ilo6_152/ilo6_msgregs152/)
