...
# Serviceroot resource definitions of iLO 6 v1.11
...
|---|---|
|`Registries`|Collection of [MessageRegistryFile](ilo6_other_resourcedefns111/#messageregistryfilecollection)|
|`Managers`|Collection of [Manager](ilo6_manager_resourcedefns111/#managercollection)|
|`AccountService`|[AccountService](ilo6_other_resourcedefns111/#accountservice)|
|`JsonSchemas`|Collection of [JsonSchemaFile](ilo6_other_resourcedefns111/#jsonschemafilecollection)|
|`UpdateService`|[UpdateService](ilo6_other_resourcedefns111/#updateservice)|
|`ComponentIntegrity`|Collection of [ComponentIntegrity](ilo6_other_resourcedefns111/#componentintegritycollection)|
|`SessionService`|[SessionService](ilo6_other_resourcedefns111/#sessionservice)|
|`EventService`|[EventService](ilo6_other_resourcedefns111/#eventservice)|
|`Chassis`|Collection of [Chassis](ilo6_chassis_resourcedefns111/#chassiscollection)|
|`Oem/Hpe/Links/ResourceDirectory`|[HpeiLOResourceDirectory](ilo6_hpe_resourcedefns111/#hpeiloresourcedirectory)|
|`Systems`|Collection of [ComputerSystem](ilo6_computersystem_resourcedefns111/#computersystemcollection)|
|`Links/Sessions`|Collection of [Session](ilo6_other_resourcedefns111/#sessioncollection)|
