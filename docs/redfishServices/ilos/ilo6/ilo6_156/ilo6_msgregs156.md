...
seo:
  title: iLO 6 v156 Error messages
toc:
  enable: false
disableLastModified: false
---

# Response message definitions of iLO 6 v1.56

This section is a reference for the defined message registry entries in HPE iLO 6 version 1.56. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
### iLO.2.26.ActionParameterValueNotInList
...
### iLO.2.26.AlertDestinationAssociationError
...
### iLO.2.26.AlertMailFeatureDisabled
...
### iLO.2.26.ApmPowerCapModeInUsed
...
### iLO.2.26.ArrayPropertyAlreadyExists
Duplicate value.
...
### iLO.2.26.ArrayPropertyOutOfBound
...
### iLO.2.26.ArrayPropertyValueBadParam
...
### iLO.2.26.AuthenticationTokenExpired
...
### iLO.2.26.BatteryBackupUnitSettingsDisabled
...
### iLO.2.26.BiosPasswordInfoInvalid
...
### iLO.2.26.BundleUpdateAlreadyInProgress
...
### iLO.2.26.BundleUpdateComponentDownloadFailed
...
### iLO.2.26.BundleUpdateComponentDownloadStatus
...
### iLO.2.26.BundleUpdateComponentInstallationFailed
...
### iLO.2.26.BundleUpdateComponentInstallationStatus
...
### iLO.2.26.BundleUpdateInstallSetCreationFailed
...
### iLO.2.26.BundleUpdateInstallSetCreationSuccess
...
### iLO.2.26.BundleUpdateInstallSetMetaDownloadFailed
...
### iLO.2.26.BundleUpdateInstallSetMetaDownloadStatus
...
### iLO.2.26.BundleUpdateInstallSetMetaProcessingFailed
...
### iLO.2.26.BundleUpdateInstallSetMetaProcessingSuccess
...
### iLO.2.26.BundleUpdateInvalidUrl
...
### iLO.2.26.BundleUpdateResetComplete
...
### iLO.2.26.BundleUpdateResetFailed
...
### iLO.2.26.BundleUpdateResetPending
...
### iLO.2.26.CannotRemoveDefaultLanguagePack
...
### iLO.2.26.CannotRemoveLanguagePack
...
### iLO.2.26.ChassisPowerDataUnAvailable
...
### iLO.2.26.ComponentUploadAlreadyInProgress
A component upload operation is already in progress.
...
### iLO.2.26.ComponentUploadFailed
...
### iLO.2.26.DailyUpdateLimitExceeded
...
### iLO.2.26.DemoLicenseKeyPreviouslyInstalled
...
### iLO.2.26.DeniedHPEOneViewUserCreation
...
### iLO.2.26.DiagsTestAlreadyRunning
...
### iLO.2.26.DowngradePolicyAlreadySet
...
### iLO.2.26.ESKMServersNotConfigured
...
### iLO.2.26.ESXioOrTarImageDownloadAlreadyInProgress
...
### iLO.2.26.EventSubscriptionModified
...
### iLO.2.26.EventSubscriptionRemoved
...
### iLO.2.26.FWFlashSuccessTPMOverrideEnabled
...
### iLO.2.26.FWFlashSuccessTrustedModuleOverrideEnabled
...
### iLO.2.26.FWFlashTPMOverrideFlagRequired
...
### iLO.2.26.FWFlashTrustedModuleOverrideFlagRequired
...
### iLO.2.26.FirmwareFlashAlreadyInProgress
...
### iLO.2.26.GeneratingCertificate
...
### iLO.2.26.HardDriveZoneBackupFailure
...
### iLO.2.26.IPv6ConfigurationError
...
### iLO.2.26.ImportCertFailCSRMissing
...
### iLO.2.26.ImportCertSuccessfuliLOResetinProgress
...
### iLO.2.26.ImportCertificateFailed
...
### iLO.2.26.IndicatorLedInvalidStateChange
...
### iLO.2.26.InterfaceDisabledResetRequired
...
### iLO.2.26.InternalErrorWithParam
The operation was not successful due to an internal service error (shown), but the service is still operational.
...
### iLO.2.26.InvalidConfigurationSpecified
The specified configuration is not valid.
...
### iLO.2.26.InvalidConfigurationSpecifiedForFederation
...
### iLO.2.26.InvalidOperationForAutoPowerOnState
...
### iLO.2.26.InvalidOperationForSystemState
...
### iLO.2.26.InvalidPassphraseLength
...
### iLO.2.26.InvalidPasswordComplexity
...
### iLO.2.26.InvalidPasswordLength
...
### iLO.2.26.InvalidSerialNumberLength
...
### iLO.2.26.InvalidUserDefAlertType
...
### iLO.2.26.InvalidUserDefSensorNumber
...
### iLO.2.26.InvalidUserDefTemperatureThresholdValue
...
### iLO.2.26.LicenseKeyNotSupported
...
### iLO.2.26.LocationIndicatorActiveInvalidStateChange
The request to change the state of the Indicator LED cannot be granted because the current state is either Blinking or is Unknown.
...
### iLO.2.26.LoginAttemptDelayedSeconds
The login was not successful, so the service enforces a delay before another login is allowed.
...
### iLO.2.26.MCTPDiscoveryDisabled
...
### iLO.2.26.MaxVirtualMediaConnectionEstablished
...
### iLO.2.26.MembistVariablesNotSupported
...
### iLO.2.26.MemoryInterleaveSetError
...
### iLO.2.26.NoSNMPAlertDestinationsConfigured
...
### iLO.2.26.NoScriptedVirtualMediaConnectionAvailable
...
### iLO.2.26.NoVirtualMediaConnectionAvailable
...
### iLO.2.26.NodeAssignedCrossRegion
...
### iLO.2.26.NonPLDMUpdateableTargetURI
...
### iLO.2.26.OperationAvailableAfterSystemPOST
...
### iLO.2.26.OperationWillCompleteAfterSystemPOST
...
### iLO.2.26.PowerLimitMayNotTakeEffect
...
### iLO.2.26.PowerRegulationNotDisable
...
### iLO.2.26.PowerSettingAdjustRequired
...
### iLO.2.26.PowerValueInvalidCalibrationData
...
### iLO.2.26.PowerValueUnAvailable
...
### iLO.2.26.PowerValueUnSupported
...
### iLO.2.26.PrimaryESKMServerAccessible
...
### iLO.2.26.PrimarySecondaryAddressesResolveToSameServer
...
### iLO.2.26.PrimarySecondaryESKMServersAccessible
...
### iLO.2.26.PropertyNotWritableOrUnknown
...
### iLO.2.26.PropertyValueAlreadySet
...
### iLO.2.26.PropertyValueBadParam
The property value is not valid.
...
### iLO.2.26.PropertyValueExceedsMaxLength
The value for the property exceeds the maximum length.
...
### iLO.2.26.PropertyValueIncompatible
The value for the property is the correct type, but this value is incompatible with the current value of another property.
...
### iLO.2.26.PropertyValueOutOfRange
The value for the property is out of range.
...
### iLO.2.26.PropertyValueRequired
...
### iLO.2.26.RecoveryInstallSetRequired
...
### iLO.2.26.RequiredPropertyMissing
...
### iLO.2.26.ResourceInUseWithDetail
...
### iLO.2.26.ResourceNotReadyRetry
The resource is present but is not ready to perform operations due to an internal condition such as initialization or reset.
...
### iLO.2.26.ResourceTemporarilyUnavailable
...
### iLO.2.26.SNTPConfigurationManagedByDHCPAndIsReadOnly
...
### iLO.2.26.SSOCertificateReadError
...
### iLO.2.26.SecondaryESKMServerAccessible
...
### iLO.2.26.ServerConfigLockStatusUnknown
...
### iLO.2.26.ServerConfigurationLockEnabled
...
### iLO.2.26.SimpleUpdateInvalidImageOrCredentials
...
### iLO.2.26.SimpleUpdateInvalidImageURI
...
### iLO.2.26.SyslogFeatureDisabled
...
### iLO.2.26.SystemPowerOffRequired
...
### iLO.2.26.SystemPowerStateChangeFailed
...
### iLO.2.26.UnableToModifyAfterVirtualMediaInsert
...
### iLO.2.26.UnableToModifyDueToMissingComponent
...
### iLO.2.26.UnableToModifyDuringSystemPOST
...
### iLO.2.26.UnableToModifyWhileKVMIPConnected
...
### iLO.2.26.UnauthorizedLoginAttempt
...
### iLO.2.26.UnsupportedCipherAlgo
...
### iLO.2.26.UnsupportedOperationACEEnabled
...
### iLO.2.26.UnsupportedOperationInChassisVersion
...
### iLO.2.26.UnsupportedOperationInLegacyBootMode
...
### iLO.2.26.UnsupportedOperationInSystemBIOS
...
### iLO.2.26.UnsupportedOperationWeakCipherDisabled
...
### iLO.2.26.UnsupportedSecurityState
...
### iLO.2.26.UpdateDependencyFailure
...
### iLO.2.26.UpdateRepositoryUnavailable
...
### iLO.2.26.UpdateTaskQueueWriteError
...
### iLO.2.26.UpdateTemporarilyUnavailable
...
### iLO.2.26.UserNameAlreadyExists
...
### iLO.2.26.VirtualMediaIsDisabled
...
### iLO.2.26.ZonePowerLimitExceeded
...
### iLO.2.26.iLOResetAndSystemRebootRequired
...
### iLO.2.26.iLOVirtualNICDisabled
