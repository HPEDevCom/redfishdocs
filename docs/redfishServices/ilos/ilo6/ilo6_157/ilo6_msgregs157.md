...
seo:
  title: iLO 6 v157 Error messages
toc:
  enable: false
disableLastModified: false
---

# Response message definitions of iLO 6 v1.57

This section is a reference for the defined message registry entries in HPE iLO 6 version 1.57. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
