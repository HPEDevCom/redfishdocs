...
# Hpe resource definitions of iLO 6 v1.69
...
|---|---|
|`CACertificates`|Collection of [HpeCertificate](ilo6_hpe_resourcedefns169/#hpecertificatecollection)|
|`Links/UserCertificateMapping`|Collection of [HpeiLOAccountCertificateMap](ilo6_hpe_resourcedefns169/#hpeiloaccountcertificatemapcollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeCertificate](ilo6_hpe_resourcedefns169/#hpecertificate)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeComponent](ilo6_hpe_resourcedefns169/#hpecomponent)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeComponentInstallSet](ilo6_hpe_resourcedefns169/#hpecomponentinstallset)|
...
`@odata.type: "#HpeComponentUpdateTask.v1_6_0.HpeComponentUpdateTask"`
...
**AdditionalErrorDetails.MessageArgs (array)**
Member of [HpeComponentUpdateTask.v1\_6\_0.HpeComponentUpdateTask](#hpecomponentupdatetask)
...
**AdditionalErrorDetails.MessageId**
Member of [HpeComponentUpdateTask.v1\_6\_0.HpeComponentUpdateTask](#hpecomponentupdatetask)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeComponentUpdateTask](ilo6_hpe_resourcedefns169/#hpecomponentupdatetask)|
...
## HpeFallbackSensorCollection

`@odata.type: "#HpeFallbackSensorCollection.HpeFallbackSensorCollection"`

A Collection of Fallback Sensors resource instances.

### Resource Instances

|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/fallbacksensors`|GET |
...
Member of HpeFallbackSensorCollection.HpeFallbackSensorCollection
...
`@odata.type: "#HpeHttpsCert.v2_1_1.HpeHttpsCert"`
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/managers/{item}/securityservice/httpscert`|GET PATCH DELETE |

### CertificateSigningRequest

Member of [HpeHttpsCert.v2\_1\_1.HpeHttpsCert](#hpehttpscert)
...
| | |
|---|---|
|Description|Indicates the algorithm used for iLO's SSL certificate, such as RSA or ECDSA.|
|Type|string|
|Read Only|False|
|Added|iLO6 1.70|
...
|Value|Description|
|---|---|
|`RSA`|SSL certificate uses RSA, a standard security method to protect your data.|
|`ECDSA`|SSL certificate uses ECDSA, a modern security method to protect your data efficiently.|

### KeyType@Redfish.AllowableValues (array)

Member of [HpeHttpsCert.v2\_1\_1.HpeHttpsCert](#hpehttpscert)

`KeyType@Redfish.AllowableValues` is an array containing elements of:

**KeyType@Redfish.AllowableValues[{item}]**
Member of [HpeHttpsCert.v2\_1\_1.HpeHttpsCert](#hpehttpscert)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeiLOAccountCertificateMap](ilo6_hpe_resourcedefns169/#hpeiloaccountcertificatemap)|
...
`@odata.type: "#HpeiLOActiveHealthSystem.v2_6_0.HpeiLOActiveHealthSystem"`
...
Member of [HpeiLOActiveHealthSystem.v2\_6\_0.HpeiLOActiveHealthSystem](#hpeiloactivehealthsystem)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeiLOBackupFile](ilo6_hpe_resourcedefns169/#hpeilobackupfile)|
...
`@odata.type: "#HpeiLOCloudConnect.v1_0_0.HpeiLOCloudConnect"`

The HpeiLOCloudConnect object extends the Redfish Manager resource with additional HPE CloudConnect functionality.

### Resource Instances

|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/managers/{item}/Oem/Hpe/cloudconnect`|GET POST |

### CloudConnect

**CloudConnect.CloudConnectStatus**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**CloudConnect.ExtendedStatusInfo**
**CloudConnect.ExtendedStatusInfo.NetworkConfig**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**CloudConnect.ExtendedStatusInfo.WebConnectivity**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**CloudConnect.ExtendedStatusInfo.iLOConfigForCloudConnect**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**CloudConnect.InsightInfo**
**CloudConnect.InsightInfo.TextEn**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**CloudConnect.InsightInfo.TextJa**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**CloudConnect.InsightInfo.TextZh**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
### FirmwareConnectivityTestReport

**FirmwareConnectivityTestReport.ConnectionURLs (array)**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)

`ConnectionURLs` is an array containing elements of:

**ConnectionURLs[{item}].DownloadSize**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**ConnectionURLs[{item}].DownloadTime**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)

| | |
|---|---|
|Description|The time taken to download the file in milliseconds.|
|Type|integer|
|Read Only|False|
|Added|iLO6 1.70|

**ConnectionURLs[{item}].FailReason**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)

| | |
|---|---|
|Description|The reason for the failure of the connectivity test.|
|Type|string|
|Read Only|True|
|Added|iLO6 1.70|

**ConnectionURLs[{item}].Status**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
See the Redfish standard schema and specification for information on common Status object.

**ConnectionURLs[{item}].TestType**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
...
**FirmwareConnectivityTestReport.Version**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)

| | |
|---|---|
|Description|Version of the connectivity test report. The format will be 'MajorVersion.MinorVersion'|
|Type|string|
|Read Only|True|
|Added|iLO6 1.70|
...
**HpeiLOCloudConnect.ForceStopFirmwareConnectivityTest**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
Action to forcibly stop the firmware connectivity test and delete the configuration.

There are no parameters for this action.

**HpeiLOCloudConnect.FirmwareUpdateConnectivityTest**
Member of [HpeiLOCloudConnect.v1\_0\_0.HpeiLOCloudConnect](#hpeilocloudconnect)
Action to invoke the firmware connectivity test.

**Parameters:**

**ConnectionURLs (array)**

The array of connection URLs to be tested.

## HpeiLODateTime

`@odata.type: "#HpeiLODateTime.v2_0_1.HpeiLODateTime"`
...
|Link Name|Destination type|
|---|---|
|`Links/EthernetNICs`|Collection of [EthernetInterface](ilo6_network_resourcedefns169/#ethernetinterfacecollection)|

### ConfigurationSettings

Member of [HpeiLODateTime.v2\_0\_1.HpeiLODateTime](#hpeilodatetime)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeiLOFederationGroup](ilo6_hpe_resourcedefns169/#hpeilofederationgroup)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeiLOFederationPeers](ilo6_hpe_resourcedefns169/#hpeilofederationpeers)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeiLOFrus](ilo6_hpe_resourcedefns169/#hpeilofrus)|
...
`@odata.type: "#HpeiLOLicense.v2_5_0.HpeiLOLicense"`
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/managers/{item}/licenseservice/{item}`|GET PATCH DELETE |
...
**SubscriptionLicense.ActiveDaysRemainingOnDisconnect**
Member of [HpeiLOLicense.v2\_5\_0.HpeiLOLicense](#hpeilolicense)
...
**SubscriptionLicense.ExpiryTimestamp**
Member of [HpeiLOLicense.v2\_5\_0.HpeiLOLicense](#hpeilolicense)
...
**SubscriptionLicense.IsActiveOnDisconnect**
Member of [HpeiLOLicense.v2\_5\_0.HpeiLOLicense](#hpeilolicense)
...
**SubscriptionLicense.MaxActiveDaysOnDisconnect**
Member of [HpeiLOLicense.v2\_5\_0.HpeiLOLicense](#hpeilolicense)
...
**SubscriptionLicense.ValidDaysRemaining**
Member of [HpeiLOLicense.v2\_5\_0.HpeiLOLicense](#hpeilolicense)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeiLOLicense](ilo6_hpe_resourcedefns169/#hpeilolicense)|
...
### Oem.Hpe.CloudSubscriptionSupport

Member of HpeiLOLicenseCollection.HpeiLOLicenseCollection

| | |
|---|---|
|Description|Indicates that this service supports cloud-based subscription license.|
|Type|boolean|
|Read Only|True|
|Added|iLO6 1.68|
...
|Link Name|Destination type|
|---|---|
|`SecurityParameters`|[HpeiLOSecurityParam](ilo6_hpe_resourcedefns169/#hpeilosecurityparam)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeiLOSecurityParam](ilo6_hpe_resourcedefns169/#hpeilosecurityparam)|
...
|`SNMPAlertDestinations`|Collection of [HpeSNMPAlertDestination](ilo6_hpe_resourcedefns169/#hpesnmpalertdestinationcollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeInvalidImage](ilo6_hpe_resourcedefns169/#hpeinvalidimage)|
...
|Link Name|Destination type|
|---|---|
|`@Redfish.Settings/SettingsObject`|[HpeiSCSISoftwareInitiator](ilo6_hpe_resourcedefns169/#hpeiscsisoftwareinitiator)|
|`Oem/Hpe/Links/BaseConfigs`|[HpeBaseConfigs](ilo6_hpe_resourcedefns169/#hpebaseconfigs)|
...
|Link Name|Destination type|
|---|---|
|`settings`|[HpeKmsConfig](ilo6_hpe_resourcedefns169/#hpekmsconfig)|
|`Oem/Hpe/Links/baseconfigs`|[HpeBaseConfigs](ilo6_hpe_resourcedefns169/#hpebaseconfigs)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeMaintenanceWindow](ilo6_hpe_resourcedefns169/#hpemaintenancewindow)|
...
|Link Name|Destination type|
|---|---|
|`ServiceEventLogs`|Collection of [LogEntry](ilo6_other_resourcedefns169/#logentrycollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeSecureEraseReport](ilo6_hpe_resourcedefns169/#hpesecureerasereport)|
...
|Link Name|Destination type|
|---|---|
|`Links/SecureEraseReportEntries`|Collection of [HpeSecureEraseReport](ilo6_hpe_resourcedefns169/#hpesecureerasereportcollection)|
...
|Link Name|Destination type|
|---|---|
|`SystemLDevID`|Collection of [Certificate](ilo6_other_resourcedefns169/#certificatecollection)|
|`Links/HttpsCert`|[HpeHttpsCert](ilo6_hpe_resourcedefns169/#hpehttpscert)|
|`BMCHPELDevID`|Collection of [Certificate](ilo6_other_resourcedefns169/#certificatecollection)|
|`Links/SSO`|[HpeiLOSSO](ilo6_hpe_resourcedefns169/#hpeilosso)|
|`BMCIDevIDPCA`|Collection of [Certificate](ilo6_other_resourcedefns169/#certificatecollection)|
|`BMCLAK`|Collection of [Certificate](ilo6_other_resourcedefns169/#certificatecollection)|
|`Links/SecurityParams`|Collection of [HpeiLOSecurityParam](ilo6_hpe_resourcedefns169/#hpeilosecurityparamcollection)|
|`Links/AutomaticCertificateEnrollment`|[HpeAutomaticCertEnrollment](ilo6_hpe_resourcedefns169/#hpeautomaticcertenrollment)|
|`BMCIAK`|Collection of [Certificate](ilo6_other_resourcedefns169/#certificatecollection)|
|`SystemLAK`|Collection of [Certificate](ilo6_other_resourcedefns169/#certificatecollection)|
|`Links/CertAuth`|[HpeCertAuth](ilo6_hpe_resourcedefns169/#hpecertauth)|
|`Links/ESKM`|[HpeESKM](ilo6_hpe_resourcedefns169/#hpeeskm)|
|`Links/SecurityDashboard`|[HpeiLOSecurityDashboard](ilo6_hpe_resourcedefns169/#hpeilosecuritydashboard)|
...
|Link Name|Destination type|
|---|---|
|`@Redfish.Settings/SettingsObject`|[HpeServerBootSettings](ilo6_hpe_resourcedefns169/#hpeserverbootsettings)|
|`Oem/Hpe/Links/BaseConfigs`|[HpeBaseConfigs](ilo6_hpe_resourcedefns169/#hpebaseconfigs)|
...
|Link Name|Destination type|
|---|---|
|`@Redfish.Settings/SettingsObject`|[HpeServerConfigLock](ilo6_hpe_resourcedefns169/#hpeserverconfiglock)|
|`Oem/Hpe/Links/BaseConfigs`|[HpeBaseConfigs](ilo6_hpe_resourcedefns169/#hpebaseconfigs)|
...
|Link Name|Destination type|
|---|---|
|`DeviceInstances[]`|[HpeServerPciDevice](ilo6_hpe_resourcedefns169/#hpeserverpcidevice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeServerDevice](ilo6_hpe_resourcedefns169/#hpeserverdevice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeServerPciDevice](ilo6_hpe_resourcedefns169/#hpeserverpcidevice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeServerPCISlot](ilo6_hpe_resourcedefns169/#hpeserverpcislot)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeSNMPAlertDestination](ilo6_hpe_resourcedefns169/#hpesnmpalertdestination)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeSNMPUser](ilo6_hpe_resourcedefns169/#hpesnmpuser)|
...
|Link Name|Destination type|
|---|---|
|`@Redfish.Settings/SettingsObject`|[HpeTlsConfig](ilo6_hpe_resourcedefns169/#hpetlsconfig)|
|`Oem/Hpe/Links/BaseConfigs`|[HpeBaseConfigs](ilo6_hpe_resourcedefns169/#hpebaseconfigs)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeUSBDevice](ilo6_hpe_resourcedefns169/#hpeusbdevice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeUSBPort](ilo6_hpe_resourcedefns169/#hpeusbport)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HpeWorkloadPerformanceAdvisor](ilo6_hpe_resourcedefns169/#hpeworkloadperformanceadvisor)|
