...
# Computersystem resource definitions of iLO 6 v1.69
...
|---|---|
|`Members[]`|[ComputerSystem](ilo6_computersystem_resourcedefns169/#computersystem)|
...
operations at the backend level, Hewlett Packard Enterprise recommends
...
|`Links/Chassis[]`|[Chassis](ilo6_chassis_resourcedefns169/#chassis)|
|`Memory`|Collection of [Memory](ilo6_other_resourcedefns169/#memorycollection)|
|`Oem/Hpe/Links/USBPorts`|Collection of [HpeUSBPort](#hpeusbport)|
|`Oem/Hpe/Links/NetworkAdapters`|HpeBaseNetworkAdapterCollection|
|`NetworkInterfaces`|Collection of [NetworkInterface](ilo6_network_resourcedefns169/#networkinterfacecollection)|
|`Processors`|Collection of [Processor](ilo6_other_resourcedefns169/#processorcollection)|
|`SecureBoot`|[SecureBoot](ilo6_other_resourcedefns169/#secureboot)|
|`Storage`|Collection of [Storage](ilo6_storage_resourcedefns169/#storagecollection)|
|`Bios`|[Bios](ilo6_bios_resourcedefns169/#bios)|
...
|`Oem/Hpe/Links/PCISlots`|Collection of [HpeServerPCISlot](ilo6_hpe_resourcedefns169/#hpeserverpcislotcollection)|
|`Links/ManagedBy[]`|[Manager](ilo6_manager_resourcedefns169/#manager)|
|`Oem/Hpe/Links/PCIDevices`|Collection of [HpeServerPciDevice](ilo6_hpe_resourcedefns169/#hpeserverpcidevicecollection)|
...
**Oem.Hpe.AggregateHealthStatus.AirFilter**
**Oem.Hpe.AggregateHealthStatus.AirFilter.Status**
Member of [ComputerSystem.v1\_18\_0.ComputerSystem](#computersystem)
See the Redfish standard schema and specification for information on common Status object.
