...
# Chassis resource definitions of iLO 6 v1.70
...
|---|---|
|`Members[]`|[Chassis](ilo6_chassis_resourcedefns170/#chassis)|
...
|Link Name|Destination type|
|---|---|
|`Links/ComputerSystems[]`|[ComputerSystem](ilo6_computersystem_resourcedefns170/#computersystem)|
|`ThermalSubsystem`|[ThermalSubsystem](ilo6_other_resourcedefns170/#thermalsubsystem)|
|`FallbackSensors`|Collection of [Sensor](ilo6_other_resourcedefns170/#sensorcollection)|
|`Links/ManagedBy[]`|[Manager](ilo6_manager_resourcedefns170/#manager)|
|`Oem/Hpe/Links/Devices`|Collection of [HpeServerDevice](ilo6_hpe_resourcedefns170/#hpeserverdevicecollection)|
|`Sensors`|Collection of [Sensor](ilo6_other_resourcedefns170/#sensorcollection)|
|`NetworkAdapters`|Collection of [NetworkAdapter](ilo6_network_resourcedefns170/#networkadaptercollection)|
|`Power`|[Power](ilo6_other_resourcedefns170/#power)|
|`Thermal`|[Thermal](ilo6_other_resourcedefns170/#thermal)|
...
PowerSubsystem is a link (`"@odata.id": URI`) to another resource.
