...
# Other resource definitions of iLO 6 v1.70
...
|---|---|
|`Accounts`|Collection of [ManagerAccount](ilo6_manager_resourcedefns170/#manageraccountcollection)|
...
**Assemblies[{item}].ProductionDate**
Member of [Assembly.v1\_5\_0.Assembly](#assembly)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[BootOption](ilo6_other_resourcedefns170/#bootoption)|
...
Member of [Certificate.v1\_8\_0.Certificate](#certificate)
...
### CertificateUsageTypes (array)

Member of [Certificate.v1\_8\_0.Certificate](#certificate)

`CertificateUsageTypes` is an array containing elements of:

**CertificateUsageTypes[{item}]**
Member of [Certificate.v1\_8\_0.Certificate](#certificate)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Certificate](ilo6_other_resourcedefns170/#certificate)|
...
|Link Name|Destination type|
|---|---|
|`Links/CertificateLocations`|[CertificateLocations](ilo6_other_resourcedefns170/#certificatelocations)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[ComponentIntegrity](ilo6_other_resourcedefns170/#componentintegrity)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[EventDestination](ilo6_other_resourcedefns170/#eventdestination)|
...
|Link Name|Destination type|
|---|---|
|`Subscriptions`|Collection of [EventDestination](ilo6_other_resourcedefns170/#eventdestinationcollection)|
|`Oem/Hpe/CACertificates`|Collection of [HpeCertificate](ilo6_hpe_resourcedefns170/#hpecertificatecollection)|
...
### EventFormatTypes (array)

Member of [EventService.v1\_7\_2.EventService](#eventservice)

`EventFormatTypes` is an array containing elements of:

**EventFormatTypes[{item}]**
Member of [EventService.v1\_7\_2.EventService](#eventservice)
...
|Link Name|Destination type|
|---|---|
|`switches`|Collection of [Switch](ilo6_other_resourcedefns170/#switchcollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Fabric](ilo6_other_resourcedefns170/#fabric)|
...
|Link Name|Destination type|
|---|---|
|`assembly`|[Assembly](ilo6_other_resourcedefns170/#assembly)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Fan](ilo6_other_resourcedefns170/#fan)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HostInterface](ilo6_other_resourcedefns170/#hostinterface)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[JsonSchemaFile](ilo6_other_resourcedefns170/#jsonschemafile)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Key](ilo6_other_resourcedefns170/#key)|
...
Member of [LogEntry.v1\_15\_0.LogEntry](#logentry)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[LogEntry](ilo6_other_resourcedefns170/#logentry)|
...
**Members[{item}].AdditionalDataURI**
Member of LogEntryCollection.LogEntryCollection
...
**Members[{item}].DiagnosticDataType**
Member of LogEntryCollection.LogEntryCollection
...
|Link Name|Destination type|
|---|---|
|`Entries`|Collection of [LogEntry](ilo6_other_resourcedefns170/#logentrycollection)|

### DateTime

Member of [LogService.v1\_5\_0.LogService](#logservice)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[LogService](ilo6_other_resourcedefns170/#logservice)|
...
|Link Name|Destination type|
|---|---|
|`memorymetrics`|[MemoryMetrics](ilo6_other_resourcedefns170/#memorymetrics)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MemoryChunks](ilo6_other_resourcedefns170/#memorychunks)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Memory](ilo6_other_resourcedefns170/#memory)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MemoryDomain](ilo6_other_resourcedefns170/#memorydomain)|
...
Member of [MemoryMetrics.v1\_7\_3.MemoryMetrics](#memorymetrics)

| | |
|---|---|
|Description|This property shall contain Memory page counters for this resource.|
|Type|integer|
|Read Only|True|
|Added|iLO6 1.61|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MessageRegistryFile](ilo6_other_resourcedefns170/#messageregistryfile)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricDefinition](ilo6_other_resourcedefns170/#metricdefinition)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricReport](ilo6_other_resourcedefns170/#metricreport)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricReportDefinition](ilo6_other_resourcedefns170/#metricreportdefinition)|
...
|Link Name|Destination type|
|---|---|
|`PCIeFunctions`|[PCIeFunction](ilo6_other_resourcedefns170/#pciefunction)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[PCIeDevice](ilo6_other_resourcedefns170/#pciedevice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[PCIeFunction](ilo6_other_resourcedefns170/#pciefunction)|
...
**Slots[{item}].Location.PhysicalAddress**
**Slots[{item}].Location.PhysicalAddress.ISOCountryCode**
Member of [PCIeSlots.v1\_3\_0.PCIeSlots](#pcieslots)
...
**Slots[{item}].Location.PhysicalAddress.ISOSubdivisionCode**
Member of [PCIeSlots.v1\_3\_0.PCIeSlots](#pcieslots)
...
**Slots[{item}].Location.PhysicalAddress.PostalCode**
Member of [PCIeSlots.v1\_3\_0.PCIeSlots](#pcieslots)
...
|Link Name|Destination type|
|---|---|
|`Metrics`|[PortMetrics](ilo6_other_resourcedefns170/#portmetrics)|
|`settings`|[Port](ilo6_other_resourcedefns170/#port)|
...
**Ethernet.LLDPReceive.SystemCapabilities (array)**
Member of [Port.v1\_12\_0.Port](#port)

`SystemCapabilities` is an array containing elements of:

**SystemCapabilities[{item}]**
Member of [Port.v1\_12\_0.Port](#port)
...
**Ethernet.LLDPReceive.SystemDescription**
Member of [Port.v1\_12\_0.Port](#port)
...
**Ethernet.LLDPReceive.SystemName**
Member of [Port.v1\_12\_0.Port](#port)
...
**Ethernet.LLDPTransmit.SystemCapabilities (array)**
Member of [Port.v1\_12\_0.Port](#port)
...
**Ethernet.LLDPTransmit.SystemDescription**
Member of [Port.v1\_12\_0.Port](#port)
...
**Ethernet.LLDPTransmit.SystemName**
Member of [Port.v1\_12\_0.Port](#port)
...
**Location.PhysicalAddress.ISOCountryCode**
Member of [Port.v1\_12\_0.Port](#port)
...
**Location.PhysicalAddress.ISOSubdivisionCode**
Member of [Port.v1\_12\_0.Port](#port)
...
Metrics is a link (`"@odata.id": URI`) to another resource.
...
|`/redfish/v1/fabrics/{item}/switches/{item}/ports`|GET |
|`/redfish/v1/managers/{item}/dedicatednetworkports`|GET |
|`/redfish/v1/managers/{item}/sharednetworkports`|GET |
|`/redfish/v1/systems/{item}/networkinterfaces/{item}/ports`|GET POST PATCH |
|`/redfish/v1/systems/{item}/storage/{item}/controllers/{item}/ports`|GET POST |
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Port](ilo6_other_resourcedefns170/#port)|
...
This schema represents the port metrics

### Resource Instances

|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/networkadapters/{item}/ports/{item}/metrics`|GET |

### Transceivers (array)

Member of [PortMetrics.v1\_7\_0.PortMetrics](#portmetrics)

`Transceivers` is an array containing elements of:

**Transceivers[{item}].WavelengthNanometers**
Member of [PortMetrics.v1\_7\_0.PortMetrics](#portmetrics)
...
|Link Name|Destination type|
|---|---|
|`Oem/Hpe/Links/FederatedGroupCapping`|[HpeiLOFederatedGroupCapping](ilo6_hpe_resourcedefns170/#hpeilofederatedgroupcapping)|
|`Oem/Hpe/Links/PowerMeter`|[HpePowerMeter](ilo6_hpe_resourcedefns170/#hpepowermeter)|
|`Redundancy[]/RedundancySet[]`|[Power](ilo6_other_resourcedefns170/#power)|
|`Oem/Hpe/Links/FastPowerMeter`|[HpePowerMeter](ilo6_hpe_resourcedefns170/#hpepowermeter)|
...
**PowerSupplies[{item}].HotPluggable**
Member of [Power.v1\_7\_1.Power](#power)
...
**PowerSupplies[{item}].Oem.Hpe.Version**
Member of [Power.v1\_7\_1.Power](#power)
...
|Link Name|Destination type|
|---|---|
|`environmentmetrics`|[EnvironmentMetrics](ilo6_other_resourcedefns170/#environmentmetrics)|
|`processormetrics`|[ProcessorMetrics](ilo6_other_resourcedefns170/#processormetrics)|

### EnvironmentMetrics

The link to the environment metrics for this processor.
EnvironmentMetrics is a link (`"@odata.id": URI`) to another resource.

### InstructionSet

Member of [Processor.v1\_8\_2.Processor](#processor)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Processor](ilo6_other_resourcedefns170/#processor)|
...
Member of [ProcessorMetrics.v1\_6\_4.ProcessorMetrics](#processormetrics)
...
**PCIeConnectionLinksStatus[{item}]**
Member of [ProcessorMetrics.v1\_6\_4.ProcessorMetrics](#processormetrics)
...
**PumpSpeedPercent.DataSourceUri**
Member of [Pump.v1\_1\_0.Pump](#pump)
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/thermalsubsystem/pumps`|GET |

### Links to other Resources

|Link Name|Destination type|
|---|---|
|`Members[]`|[Pump](ilo6_other_resourcedefns170/#pump)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Role](ilo6_other_resourcedefns170/#role)|
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/systems/{item}/secureboot`|GET PATCH |

### Links to other Resources

|Link Name|Destination type|
|---|---|
|`securebootdatabases`|Collection of [SecureBootDatabase](ilo6_other_resourcedefns170/#securebootdatabasecollection)|
...
|Link Name|Destination type|
|---|---|
|`Certificates`|Collection of [Certificate](ilo6_other_resourcedefns170/#certificatecollection)|
|`Signatures`|Collection of [Signature](ilo6_other_resourcedefns170/#signaturecollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[SecureBootDatabase](ilo6_other_resourcedefns170/#securebootdatabase)|
...
### Oem.Hpe.CriticalTempUserThreshold

Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
### Oem.Hpe.FallBackDisabled

Member of [Sensor.v1\_10\_1.Sensor](#sensor)

| | |
|---|---|
|Description|Setting the fallback temperature sensor status|
|Type|boolean|
|Read Only|False|
|Added|iLO6 1.69|

### Oem.Hpe.FallbackOverride

Member of [Sensor.v1\_10\_1.Sensor](#sensor)

| | |
|---|---|
|Description|If true then confirmation provided to alter the 'FallBackDisabled' flag|
|Type|boolean|
|Read Only|False|
|Added|iLO6 1.69|
...
### Oem.Hpe.WarningTempUserThreshold
...
**Thresholds.LowerCaution.Activation**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.LowerCaution.DwellTime**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.LowerCritical.Activation**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.LowerCritical.DwellTime**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperCaution.Activation**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperCaution.DwellTime**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperCautionUser**
**Thresholds.UpperCautionUser.Reading**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperCritical.Activation**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperCritical.DwellTime**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperCriticalUser**
**Thresholds.UpperCriticalUser.Reading**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperFatal**
**Thresholds.UpperFatal.Activation**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
**Thresholds.UpperFatal.DwellTime**
Member of [Sensor.v1\_10\_1.Sensor](#sensor)
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/sensors`|GET |

### Links to other Resources

|Link Name|Destination type|
|---|---|
|`Members[]`|[Sensor](ilo6_other_resourcedefns170/#sensor)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[SerialInterface](ilo6_other_resourcedefns170/#serialinterface)|
...
|Link Name|Destination type|
|---|---|
|`Oem/Hpe/Links/MySession`|[Session](ilo6_other_resourcedefns170/#session)|
|`Members[]`|[Session](ilo6_other_resourcedefns170/#session)|
...
|Link Name|Destination type|
|---|---|
|`Sessions`|Collection of [Session](ilo6_other_resourcedefns170/#sessioncollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Signature](ilo6_other_resourcedefns170/#signature)|
...
Member of [SoftwareInventory.v1\_10\_0.SoftwareInventory](#softwareinventory)
...
### Oem.Hpe.DeviceSlotLocation

Member of [SoftwareInventory.v1\_10\_0.SoftwareInventory](#softwareinventory)

| | |
|---|---|
|Description|Friendly text string - same as 'Location' in fw inventory indicating the slot ID - omitted if not available.|
|Type|string|
|Read Only|True|
|Added|iLO6 1.69|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[SoftwareInventory](ilo6_other_resourcedefns170/#softwareinventory)|
...
|Link Name|Destination type|
|---|---|
|`ports`|Collection of [Port](ilo6_other_resourcedefns170/#portcollection)|

### DomainID

Member of [Switch.v1\_9\_1.Switch](#switch)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Switch](ilo6_other_resourcedefns170/#switch)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Task](ilo6_other_resourcedefns170/#task)|
...
|Link Name|Destination type|
|---|---|
|`Tasks`|Collection of [Task](ilo6_other_resourcedefns170/#taskcollection)|
...
|Link Name|Destination type|
|---|---|
|`MetricReports`|Collection of [MetricReport](ilo6_other_resourcedefns170/#metricreportcollection)|
|`MetricReportDefinitions`|Collection of [MetricDefinition](ilo6_other_resourcedefns170/#metricdefinitioncollection)|
|`Triggers`|Collection of [Triggers](ilo6_other_resourcedefns170/#triggerscollection)|
...
| | |
|---|---|
|Description|Specifies whether a leakage is detected in the liquid cooling module.|
|Type|boolean or null|
|Read Only|True|
|Added|iLO6 1.68|
...
**Temperatures[{item}].Oem.Hpe.FallBackDisabled**
Member of [Thermal.v1\_7\_1.Thermal](#thermal)
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/thermalsubsystem/thermalmetrics`|GET |

### PowerWatts

**PowerWatts.Reading**
Member of [ThermalMetrics.v1\_3\_1.ThermalMetrics](#thermalmetrics)
...
**TemperatureReadingsCelsius[{item}].DeviceName**
Member of [ThermalMetrics.v1\_3\_1.ThermalMetrics](#thermalmetrics)
...
**TemperatureReadingsCelsius[{item}].PhysicalContext**
Member of [ThermalMetrics.v1\_3\_1.ThermalMetrics](#thermalmetrics)
...
**TemperatureReadingsCelsius[{item}].Reading**
Member of [ThermalMetrics.v1\_3\_1.ThermalMetrics](#thermalmetrics)
...
**TemperatureSummaryCelsius.Ambient**
**TemperatureSummaryCelsius.Ambient.DataSourceUri**
Member of [ThermalMetrics.v1\_3\_1.ThermalMetrics](#thermalmetrics)
...
**TemperatureSummaryCelsius.Ambient.Reading**
Member of [ThermalMetrics.v1\_3\_1.ThermalMetrics](#thermalmetrics)
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/thermalsubsystem`|GET PATCH |

### Links to other Resources

|Link Name|Destination type|
|---|---|
|`Fans`|Collection of [Fan](ilo6_other_resourcedefns170/#fancollection)|

### Fans

The link to the summary of Fan Collection for this subsystem.
Fans is a link (`"@odata.id": URI`) to another resource.

### Oem.Hpe.FanPercentAdjust

Member of [ThermalSubsystem.v1\_3\_2.ThermalSubsystem](#thermalsubsystem)
...
Pumps is a link (`"@odata.id": URI`) to another resource.
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Triggers](ilo6_other_resourcedefns170/#triggers)|
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/updateservice`|GET PATCH |

### Links to other Resources

|Link Name|Destination type|
|---|---|
|`Oem/Hpe/InstallSets`|Collection of [HpeComponentInstallSet](ilo6_hpe_resourcedefns170/#hpecomponentinstallsetcollection)|
|`Oem/Hpe/ComponentRepository`|Collection of [HpeComponent](ilo6_hpe_resourcedefns170/#hpecomponentcollection)|
|`FirmwareInventory`|Collection of [SoftwareInventory](ilo6_other_resourcedefns170/#softwareinventorycollection)|
|`SoftwareInventory`|Collection of [SoftwareInventory](ilo6_other_resourcedefns170/#softwareinventorycollection)|
...
Member of [UpdateService.v1\_11\_0.UpdateService](#updateservice)
...
**HttpPushUriOptions.ForceUpdate**
Member of [UpdateService.v1\_11\_0.UpdateService](#updateservice)
...
### Oem.Hpe.AdditionalErrorDetails

**Oem.Hpe.AdditionalErrorDetails.MessageArgs (array)**
Member of [UpdateService.v1\_11\_0.UpdateService](#updateservice)
...
**Oem.Hpe.AdditionalErrorDetails.MessageId**
Member of [UpdateService.v1\_11\_0.UpdateService](#updateservice)
...
**Oem.Hpe.Capabilities.BundleUpdateForceStopSupport**
Member of [UpdateService.v1\_11\_0.UpdateService](#updateservice)

| | |
|---|---|
|Description|Indicates whether iLO supports forcefully stopping an ongoing bundle update.|
|Type|boolean|
|Read Only|True|
|Added|iLO6 1.70|
...
**Oem.Hpe.Capabilities.FirmwareUpdateConnectivityTest**
Member of [UpdateService.v1\_11\_0.UpdateService](#updateservice)

| | |
|---|---|
|Description|Indicates whether iLO supports connectivity test for firmware update.|
|Type|boolean|
|Read Only|True|
|Added|iLO6 1.70|

**Oem.Hpe.Capabilities.HostPoweroffSupport**
Member of [UpdateService.v1\_11\_0.UpdateService](#updateservice)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[VirtualMedia](ilo6_other_resourcedefns170/#virtualmedia)|
