---
seo:
  title: iLO 6 v170 Error messages
markdown:
  toc:
    hide: false
    depth: 2
...
# Response message definitions of iLO 6 v1.70

This section is a reference for the defined message registry entries in HPE iLO 6 version 1.70. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
### Base.1.18.PropertyValueError

Indicates that a property was given an invalid value.

| | |
|:---|:---|
|Message Format|"The value provided for the property %1 is not valid."|
|Severity|Warning|
...
### Base.1.18.PropertyValueResourceConflict
...
| | |
|:---|:---|
|Message Format|"The property '%1' with the requested value of '%2' could not be written because the value conflicts with the state or configuration of the resource at '%3'."|
|Severity|Warning|
|Resolution|None.|
...
### Base.1.18.ResourceCreationConflict
...
| | |
|:---|:---|
|Message Format|"The resource could not be created.  The service has a resource at URI '%1' that conflicts with the creation request."|
|Severity|Critical|
|Resolution|None.|
...
### iLO.2.34.ActionParameterValueNotInList
...
### iLO.2.34.AlertDestinationAssociationError
...
### iLO.2.34.AlertMailFeatureDisabled
...
### iLO.2.34.ApmPowerCapModeInUsed
...
### iLO.2.34.ArrayPropertyAlreadyExists
...
### iLO.2.34.ArrayPropertyOutOfBound
...
### iLO.2.34.ArrayPropertyValueBadParam
...
### iLO.2.34.AuthenticationTokenExpired
...
### iLO.2.34.BatteryBackupUnitSettingsDisabled
...
### iLO.2.34.BiosPasswordInfoInvalid
...
### iLO.2.34.BundleUpdateAlreadyInProgress
...
### iLO.2.34.BundleUpdateComponentDownloadFailed
...
### iLO.2.34.BundleUpdateComponentDownloadStatus
...
### iLO.2.34.BundleUpdateComponentInstallationFailed
...
### iLO.2.34.BundleUpdateComponentInstallationStatus
...
### iLO.2.34.BundleUpdateForceStopped

Bundle update is stopped by an user.

| | |
|:---|:---|
|Message Format|"This action shall stop an ongoing bundle update and may impact the firmware update. Additionally, this action will reset the iLO."|
|Severity|Critical|
|Resolution|None.|

### iLO.2.34.BundleUpdateInstallSetCreationFailed
...
### iLO.2.34.BundleUpdateInstallSetCreationSuccess
...
### iLO.2.34.BundleUpdateInstallSetMetaDownloadFailed
...
### iLO.2.34.BundleUpdateInstallSetMetaDownloadStatus
...
### iLO.2.34.BundleUpdateInstallSetMetaProcessingFailed
...
### iLO.2.34.BundleUpdateInstallSetMetaProcessingSuccess
...
### iLO.2.34.BundleUpdateInvalidUrl
...
### iLO.2.34.BundleUpdateResetComplete
...
### iLO.2.34.BundleUpdateResetFailed
...
### iLO.2.34.BundleUpdateResetPending
...
### iLO.2.34.CannotRemoveDefaultLanguagePack
...
### iLO.2.34.CannotRemoveLanguagePack
...
### iLO.2.34.ChassisPowerDataUnAvailable
...
### iLO.2.34.ComponentUploadAlreadyInProgress
...
### iLO.2.34.ComponentUploadFailed
...
### iLO.2.34.DailyUpdateLimitExceeded
...
### iLO.2.34.DemoLicenseKeyPreviouslyInstalled
...
### iLO.2.34.DeniedHPEOneViewUserCreation
...
### iLO.2.34.DiagsTestAlreadyRunning
...
### iLO.2.34.DowngradePolicyAlreadySet
...
### iLO.2.34.ESKMServersNotConfigured
...
### iLO.2.34.ESXioOrTarImageDownloadAlreadyInProgress
...
### iLO.2.34.EventSubscriptionModified
...
### iLO.2.34.EventSubscriptionRemoved
...
### iLO.2.34.FWFlashSuccessTPMOverrideEnabled
...
### iLO.2.34.FWFlashSuccessTrustedModuleOverrideEnabled
...
### iLO.2.34.FWFlashTPMOverrideFlagRequired
...
### iLO.2.34.FWFlashTrustedModuleOverrideFlagRequired
...
### iLO.2.34.FallBackSensorDisabled

iLO to disable fallback to main sensor. Changes will take effect without a management processor reset.

| | |
|:---|:---|
|Message Format|"CAUTION: HPE recommends that fallback sensors not be disabled. In the event, that you elect to disable the sensor, you acknowledge that such action will result in loss of thermal protection of the part or component and could result in failure and damage to the system. Disabling the sensor may also lead to an abrupt system shutdown and potential loss of data. Customer agrees and acknowledges that HPE will not be responsible for any related loss of data. Furthermore, parts or components that HPE determines failed due to Customer disabling the fallback sensor will not be provided, repaired, or replaced. Below are the potential consequences to each sensor when fallback sensor is disabled: Consequence: PCIe option card: System performance degradation due to thermal throttling will be triggered. Data loss and/or transmission slow down and/or shutdown due to transceiver is overheated. Potential component damage could happened. OCP option card: System performance degradation due to thermal throttling will be triggered. OCP NIC card is capable of shutting the system down when temperature reading reaches Fatal High Threshold as physical shutdown signal is routed to CPLD. Potential component damage could happened. (%1)"|
|Severity|Warning|
|Resolution|None.|

### iLO.2.34.FallBackSensorOverrideWarning

FallbackOverride should be true to enable/disable the fallback feature of the sensor
...
### iLO.2.34.FirmwareFileLocked

The firmware file is currently locked and cannot be updated.

| | |
|:---|:---|
|Message Format|"The firmware file is currently locked and cannot be updated."|
|Severity|Warning|
|Resolution|Remove the associated task or install set and retry the operation.|

### iLO.2.34.FirmwareFlashAlreadyInProgress
...
### iLO.2.34.GeneratingCertificate
...
### iLO.2.34.HardDriveZoneBackupFailure
...
### iLO.2.34.IPv6ConfigurationError
...
### iLO.2.34.ImportCertFailCSRMissing
...
### iLO.2.34.ImportCertSuccessfuliLOResetinProgress
...
### iLO.2.34.ImportCertificateFailed
...
### iLO.2.34.ImproperUsage

The firmware image was provided in an unsupported or improper format.

| | |
|:---|:---|
|Message Format|"Improper usage of firmware image. This can occur due to an invalid FWPKG structure, unsupported downgrade, or unsupported update+upload combination."|
|Severity|Warning|
|Resolution|Ensure the firmware package is appropriate for the target platform and the update method is valid.|

### iLO.2.34.IndicatorLedInvalidStateChange
...
### iLO.2.34.InterfaceDisabledResetRequired
...
### iLO.2.34.InternalErrorWithParam
...
### iLO.2.34.InvalidConfigurationSpecified
...
### iLO.2.34.InvalidConfigurationSpecifiedForFederation
...
### iLO.2.34.InvalidOperationForAutoPowerOnState
...
### iLO.2.34.InvalidOperationForSystemState
...
### iLO.2.34.InvalidPassphraseLength
...
### iLO.2.34.InvalidPasswordComplexity
...
### iLO.2.34.InvalidPasswordLength
...
### iLO.2.34.InvalidSerialNumberLength
...
### iLO.2.34.InvalidUserDefAlertType
...
### iLO.2.34.InvalidUserDefSensorNumber
...
### iLO.2.34.InvalidUserDefTemperatureThresholdValue
...
### iLO.2.34.LicenseKeyNotSupported
...
### iLO.2.34.LocationIndicatorActiveInvalidStateChange
...
### iLO.2.34.LoginAttemptDelayedSeconds
...
### iLO.2.34.MCTPDiscoveryDisabled
...
### iLO.2.34.MaxVirtualMediaConnectionEstablished
...
### iLO.2.34.MembistVariablesNotSupported
...
### iLO.2.34.MemoryInterleaveSetError
...
### iLO.2.34.MinimumFirmwareVersionRequirementNotMet

The update was rejected because the provided firmware version does not meet the system's minimum version requirement.

| | |
|:---|:---|
|Message Format|"The firmware version '{0}' is below the minimum required version for update."|
|Severity|Warning|
|Resolution|Use a newer firmware version that meets or exceeds the system's minimum requirement.|

### iLO.2.34.NandMountFailed
...
### iLO.2.34.NoMatchingDeviceFound

The update operation failed because no supported device type was found for the firmware file.

| | |
|:---|:---|
|Message Format|"No supported device type found for the firmware update file."|
|Severity|Critical|
|Resolution|Verify that the firmware file is compatible with this system's hardware configuration and retry the operation.|

### iLO.2.34.NoMatchingTargetDeviceFound

The update operation failed because the specified device type is not supported on this platform.

| | |
|:---|:---|
|Message Format|"Device type is not supported on this platform."|
|Severity|Critical|
|Resolution|Use a firmware file that is compatible with the supported device types on this platform and retry the operation.|

### iLO.2.34.NoPowerMetering
...
### iLO.2.34.NoSNMPAlertDestinationsConfigured
...
### iLO.2.34.NoScriptedVirtualMediaConnectionAvailable
...
### iLO.2.34.NoVirtualMediaConnectionAvailable
...
### iLO.2.34.NodeAssignedCrossRegion
...
### iLO.2.34.NonPLDMUpdateableTargetURI
...
### iLO.2.34.OperationAvailableAfterSystemPOST
...
### iLO.2.34.OperationWillCompleteAfterSystemPOST
...
### iLO.2.34.PowerLimitMayNotTakeEffect
...
### iLO.2.34.PowerRegulationNotDisable
...
### iLO.2.34.PowerSettingAdjustRequired
...
### iLO.2.34.PowerValueInvalidCalibrationData
...
### iLO.2.34.PowerValueUnAvailable
...
### iLO.2.34.PowerValueUnSupported
...
### iLO.2.34.PrimaryESKMServerAccessible
...
### iLO.2.34.PrimarySecondaryAddressesResolveToSameServer
...
### iLO.2.34.PrimarySecondaryESKMServersAccessible
...
### iLO.2.34.PropertyNotWritableOrUnknown
...
### iLO.2.34.PropertyValueAlreadySet
...
### iLO.2.34.PropertyValueBadParam
...
### iLO.2.34.PropertyValueExceedsMaxLength
...
### iLO.2.34.PropertyValueIncompatible
...
### iLO.2.34.PropertyValueOutOfRange
...
### iLO.2.34.PropertyValueRequired
...
### iLO.2.34.RecoveryInstallSetRequired
...
### iLO.2.34.RequiredPropertyMissing
...
### iLO.2.34.ResourceInUseWithDetail
...
### iLO.2.34.ResourceNotReadyRetry
...
### iLO.2.34.ResourceTemporarilyUnavailable
...
### iLO.2.34.SNTPConfigurationManagedByDHCPAndIsReadOnly
...
### iLO.2.34.SSOCertificateReadError
...
### iLO.2.34.SecondaryESKMServerAccessible
...
### iLO.2.34.SecureEraseInProgress

The firmware update operation was blocked because a Secure Erase operation is currently in progress.

| | |
|:---|:---|
|Message Format|"The update operation failed because a Secure Erase is in progress."|
|Severity|Warning|
|Resolution|Wait for the Secure Erase operation to complete before retrying the firmware update.|

### iLO.2.34.ServerConfigLockStatusUnknown
...
### iLO.2.34.ServerConfigurationLockEnabled
...
### iLO.2.34.SimpleUpdateInvalidImageOrCredentials
...
### iLO.2.34.SimpleUpdateInvalidImageURI
...
### iLO.2.34.SyslogFeatureDisabled
...
### iLO.2.34.SystemPowerOffRequired
...
### iLO.2.34.SystemPowerStateChangeFailed
...
### iLO.2.34.SystemSecurityRestriction

The update operation failed because the system is running a release build that enforces security restrictions preventing the update.

| | |
|:---|:---|
|Message Format|"Update failed due to security restrictions on release build systems."|
|Severity|Critical|
|Resolution|Verify the system build type and ensure updates are applied only on supported builds. Consult the documentation for secure update procedures.|

### iLO.2.34.TargetsLimitExceeded
...
### iLO.2.34.UnableToModifyAfterVirtualMediaInsert
...
### iLO.2.34.UnableToModifyDueToMissingComponent
...
### iLO.2.34.UnableToModifyDuringSystemPOST
...
### iLO.2.34.UnableToModifyWhileKVMIPConnected
...
### iLO.2.34.UnauthorizedLoginAttempt
...
### iLO.2.34.UnsupportedCipherAlgo
...
### iLO.2.34.UnsupportedOperationACEEnabled
...
### iLO.2.34.UnsupportedOperationInChassisVersion
...
### iLO.2.34.UnsupportedOperationInLegacyBootMode
...
### iLO.2.34.UnsupportedOperationInSystemBIOS
...
### iLO.2.34.UnsupportedOperationWeakCipherDisabled
...
### iLO.2.34.UnsupportedSecurityState
...
### iLO.2.34.UpdateDependencyFailure
...
### iLO.2.34.UpdateFailedInPOST

This update cannot be performed in POST.

| | |
|:---|:---|
|Message Format|"This update cannot be performed in POST."|
|Severity|Warning|
|Resolution|Ensure server is not in POST or is powered off and try again.|

### iLO.2.34.UpdateInPOST
...
### iLO.2.34.UpdateRepositoryUnavailable
...
### iLO.2.34.UpdateRepositoryUnavailableDueToBMCReset

The update operation failed because the component repository was unavailable due to a system reset in progress.

| | |
|:---|:---|
|Message Format|"The component repository is temporarily unavailable because a system reset is in progress or planned."|
|Severity|Warning|
|Resolution|Wait for the system reset to complete, then retry the update operation.|

### iLO.2.34.UpdateSignatureValidationFailed

The update operation failed because the digital signature verification for the update file failed.

| | |
|:---|:---|
|Message Format|"The update operation failed due to a signature verification failure."|
|Severity|Critical|
|Resolution|Ensure the update file is correctly signed with a valid and trusted certificate. Re-obtain the file from a trusted source and try the operation again.|

### iLO.2.34.UpdateSimpleStatus
...
### iLO.2.34.UpdateTaskQueueWriteError
...
### iLO.2.34.UpdateTemporarilyUnavailable
...
### iLO.2.34.UserNameAlreadyExists
...
### iLO.2.34.VirtualMediaIsDisabled
...
### iLO.2.34.ZonePowerLimitExceeded
...
### iLO.2.34.iLOResetAndSystemRebootRequired
...
### iLO.2.34.iLOVirtualNICDisabled
...
### iLOResourceEvents.1.4.AdapterConfigurationChange
...
### iLOResourceEvents.1.4.AggregateHealthStatusChange
...
### iLOResourceEvents.1.4.AutoShutdownCancelled
...
### iLOResourceEvents.1.4.AutoShutdownInitiated
...
### iLOResourceEvents.1.4.BIOSSafeModeEngaged
...
### iLOResourceEvents.1.4.BIOSSafeModeExit
...
### iLOResourceEvents.1.4.ComputeOpsManagerConnected
...
### iLOResourceEvents.1.4.ComputeOpsManagerConnectionFailed
...
### iLOResourceEvents.1.4.ComputeOpsManagerConnectionInProgress
...
### iLOResourceEvents.1.4.ComputeOpsManagerConnectionInitiated
...
### iLOResourceEvents.1.4.ComputeOpsManagerConnectionNotEnabled
...
### iLOResourceEvents.1.4.ComputeOpsManagerDisabledByFactoryDefaults
...
### iLOResourceEvents.1.4.ComputeOpsManagerDisabledBySecureErase
...
### iLOResourceEvents.1.4.ComputeOpsManagerDisabledByUser
...
### iLOResourceEvents.1.4.DeviceDiscoveryStatusV2
...
### iLOResourceEvents.1.4.DriveInserted2
...
### iLOResourceEvents.1.4.DriveRemoved2
...
### iLOResourceEvents.1.4.DrvArrLogDrvErasing
...
### iLOResourceEvents.1.4.DrvArrLogDrvExpanding
...
### iLOResourceEvents.1.4.DrvArrLogDrvNewLogDrvKeyRekeyRequestReceived
...
### iLOResourceEvents.1.4.DrvArrLogDrvPredictiveSpareRebuildReady
...
### iLOResourceEvents.1.4.DrvArrLogDrvQueuedForExpansion
...
### iLOResourceEvents.1.4.DrvArrLogDrvRapidParityInitializationInProgress
...
### iLOResourceEvents.1.4.DrvArrLogDrvRapidParityInitializationPending
...
### iLOResourceEvents.1.4.DrvArrLogDrvReadyRebuild
...
### iLOResourceEvents.1.4.DrvArrLogDrvRebuilding
...
### iLOResourceEvents.1.4.DrvArrLogDrvRekeyInProgress
...
### iLOResourceEvents.1.4.DrvArrLogDrvUnconfigured
...
### iLOResourceEvents.1.4.DrvArrLogDrvUnencryptedToEncryptedTransformationInProgress
...
### iLOResourceEvents.1.4.DrvArrLogDrvUnencryptedToEncryptedTransformationNotStarted
...
### iLOResourceEvents.1.4.DrvArrPhysDrvEraseDone
...
### iLOResourceEvents.1.4.DrvArrPhysDrvEraseQueued
...
### iLOResourceEvents.1.4.DrvArrPhysDrvErasing
...
### iLOResourceEvents.1.4.DrvArrSpareDriveActive
...
### iLOResourceEvents.1.4.DrvArrSpareDriveBuilding
...
### iLOResourceEvents.1.4.DrvArrSpareDriveInactive
...
### iLOResourceEvents.1.4.DrvArrayAccBoardTempDisabled_ExpandInProgress
...
### iLOResourceEvents.1.4.DrvArrayAccBoardTempDisabled_SnapshotInProgress
...
### iLOResourceEvents.1.4.FanInserted
...
### iLOResourceEvents.1.4.FanRemoved
...
### iLOResourceEvents.1.4.FansHealthOk
...
### iLOResourceEvents.1.4.FirmwareFlashStatusChanged
...
### iLOResourceEvents.1.4.FirmwareIntegrityScanComplete
...
### iLOResourceEvents.1.4.FirmwareRecoveryRequest
...
### iLOResourceEvents.1.4.IndicatorLEDStateChanged
...
### iLOResourceEvents.1.4.IntelligentDiagnosticsEnabled
...
### iLOResourceEvents.1.4.IntelligentDiagnosticsExit
...
### iLOResourceEvents.1.4.IntrusionHWInstalled
...
### iLOResourceEvents.1.4.IntrusionHWRemoved
...
### iLOResourceEvents.1.4.LiquidCoolingHealthOk
...
### iLOResourceEvents.1.4.MemoryHealthOk
...
### iLOResourceEvents.1.4.NetworkHealthOk
...
### iLOResourceEvents.1.4.PowerSuppliesHealthOk
...
### iLOResourceEvents.1.4.PowerSupplyInserted
...
### iLOResourceEvents.1.4.PowerSupplyRemoved
...
### iLOResourceEvents.1.4.ProcessorsHealthOk
...
### iLOResourceEvents.1.4.RemoteSupportRegistrationComplete
...
### iLOResourceEvents.1.4.RemoteSupportUnregistrationComplete
...
### iLOResourceEvents.1.4.SecurityStateChange
...
### iLOResourceEvents.1.4.ServerPostComplete
...
### iLOResourceEvents.1.4.ServerPostDiscoveryComplete
...
### iLOResourceEvents.1.4.ServerPoweredOff
...
### iLOResourceEvents.1.4.ServerPoweredOn
...
### iLOResourceEvents.1.4.ServerResetDetected
...
### iLOResourceEvents.1.4.SmartStorageBatteryHealthOk
...
### iLOResourceEvents.1.4.StorageHealthOk
...
### iLOResourceEvents.1.4.TemperatureHealthOk
...
### iLOResourceEvents.1.4.UpdateTaskStateChanged
...
### iLOResourceEvents.1.4.iLODriveComponentAdded
...
### iLOResourceEvents.1.4.iLORestServicesStarted
...
### iLOSecurityEvents.6.1.AccessPanelStatusAtOK
...
### iLOSecurityEvents.6.1.AccessPanelStatusAtRisk
...
### iLOSecurityEvents.6.1.DefaultSSLCertificateAtIgnore
...
### iLOSecurityEvents.6.1.DefaultSSLCertificateAtOK
...
### iLOSecurityEvents.6.1.DefaultSSLCertificateAtRisk
...
### iLOSecurityEvents.6.1.GlobalComponentIntegrityAtIgnore
...
### iLOSecurityEvents.6.1.GlobalComponentIntegrityAtOK
...
### iLOSecurityEvents.6.1.GlobalComponentIntegrityAtRisk
...
### iLOSecurityEvents.6.1.IPMIOverLANAtIgnore
...
### iLOSecurityEvents.6.1.IPMIOverLANAtOK
...
### iLOSecurityEvents.6.1.IPMIOverLANAtRisk
...
### iLOSecurityEvents.6.1.LastFWScanAtIgnore
...
### iLOSecurityEvents.6.1.LastFWScanAtOK
...
### iLOSecurityEvents.6.1.LastFWScanAtRisk
...
### iLOSecurityEvents.6.1.LogAuthFailureAtIgnore
...
### iLOSecurityEvents.6.1.LogAuthFailureAtOK
...
### iLOSecurityEvents.6.1.LogAuthFailureAtRisk
...
### iLOSecurityEvents.6.1.MinPasswordLengthAtIgnore
...
### iLOSecurityEvents.6.1.MinPasswordLengthAtOK
...
### iLOSecurityEvents.6.1.MinPasswordLengthAtRisk
...
### iLOSecurityEvents.6.1.OverallSecAtIgnore
...
### iLOSecurityEvents.6.1.OverallSecAtOK
...
### iLOSecurityEvents.6.1.OverallSecAtRisk
...
### iLOSecurityEvents.6.1.PasswordComplexityAtIgnore
...
### iLOSecurityEvents.6.1.PasswordComplexityAtOK
...
### iLOSecurityEvents.6.1.PasswordComplexityAtRisk
...
### iLOSecurityEvents.6.1.RBSULoginRequiredAtIgnore
...
### iLOSecurityEvents.6.1.RBSULoginRequiredAtOK
...
### iLOSecurityEvents.6.1.RBSULoginRequiredAtRisk
...
### iLOSecurityEvents.6.1.RequireHostAuthAtIgnore
...
### iLOSecurityEvents.6.1.RequireHostAuthAtOK
...
### iLOSecurityEvents.6.1.RequireHostAuthAtRisk
...
### iLOSecurityEvents.6.1.SNMPv1AtIgnore
...
### iLOSecurityEvents.6.1.SNMPv1AtOK
...
### iLOSecurityEvents.6.1.SNMPv1AtRisk
...
### iLOSecurityEvents.6.1.SecOverrideSwitchAtIgnore
...
### iLOSecurityEvents.6.1.SecOverrideSwitchAtOK
...
### iLOSecurityEvents.6.1.SecOverrideSwitchAtRisk
...
### iLOSecurityEvents.6.1.SecureBootAtIgnore
...
### iLOSecurityEvents.6.1.SecureBootAtOK
...
### iLOSecurityEvents.6.1.SecureBootAtRisk
...
### iLOSecurityEvents.6.1.WeakCipherDisabled
...
### iLOSecurityEvents.6.1.WeakCipherEnabled
