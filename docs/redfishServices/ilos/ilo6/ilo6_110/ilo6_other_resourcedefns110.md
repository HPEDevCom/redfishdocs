...
# Other resource definitions of iLO 6 v1.10
...
|---|---|
|`Accounts`|Collection of [ManagerAccount](../ilo6_manager_resourcedefns110/#manageraccountcollection)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[BootOption](../ilo6_other_resourcedefns110/#bootoption)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Certificate](../ilo6_other_resourcedefns110/#certificate)|
...
|Link Name|Destination type
|---|---|
|`Links/CertificateLocations`|[CertificateLocations](../ilo6_other_resourcedefns110/#certificatelocations)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[ComponentIntegrity](../ilo6_other_resourcedefns110/#componentintegrity)|
...
Member of [EventDestination.v1\_0\_0.EventDestination](#eventdestination)
...
|Link Name|Destination type
|---|---|
|`Members[]`|[EventDestination](../ilo6_other_resourcedefns110/#eventdestination)|
...
|Link Name|Destination type
|---|---|
|`Subscriptions`|Collection of [EventDestination](../ilo6_other_resourcedefns110/#eventdestinationcollection)|
|`Oem/Hpe/CACertificates`|Collection of [HpeCertificate](../ilo6_hpe_resourcedefns110/#hpecertificatecollection)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[HostInterface](../ilo6_other_resourcedefns110/#hostinterface)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[JsonSchemaFile](../ilo6_other_resourcedefns110/#jsonschemafile)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[LogEntry](../ilo6_other_resourcedefns110/#logentry)|
...
|Link Name|Destination type
|---|---|
|`Entries`|Collection of [LogEntry](../ilo6_other_resourcedefns110/#logentrycollection)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[LogService](../ilo6_other_resourcedefns110/#logservice)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[MemoryChunks](../ilo6_other_resourcedefns110/#memorychunks)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Memory](../ilo6_other_resourcedefns110/#memory)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[MemoryDomain](../ilo6_other_resourcedefns110/#memorydomain)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[MessageRegistryFile](../ilo6_other_resourcedefns110/#messageregistryfile)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[MetricDefinition](../ilo6_other_resourcedefns110/#metricdefinition)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[MetricReport](../ilo6_other_resourcedefns110/#metricreport)|
...
Member of [MetricReportDefinition.v1\_0\_0.MetricReportDefinition](#metricreportdefinition)
...
|Link Name|Destination type
|---|---|
|`Members[]`|[MetricReportDefinition](../ilo6_other_resourcedefns110/#metricreportdefinition)|
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/pciedevices/{item}`|GET |

### Links to other Resources

|Link Name|Destination type
|---|---|
|`PCIeFunctions`|[PCIeFunction](../ilo6_other_resourcedefns110/#pciefunction)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[PCIeDevice](../ilo6_other_resourcedefns110/#pciedevice)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[PCIeFunction](../ilo6_other_resourcedefns110/#pciefunction)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Port](../ilo6_other_resourcedefns110/#port)|

### @Redfish.Settings

Member of [Port.v1\_6\_1.Port](#port)
...
|Link Name|Destination type
|---|---|
|`Oem/Hpe/Links/FederatedGroupCapping`|[HpeiLOFederatedGroupCapping](../ilo6_hpe_resourcedefns110/#hpeilofederatedgroupcapping)|
|`Oem/Hpe/Links/PowerMeter`|[HpePowerMeter](../ilo6_hpe_resourcedefns110/#hpepowermeter)|
|`Redundancy[]/RedundancySet[]`|[Power](../ilo6_other_resourcedefns110/#power)|
|`Oem/Hpe/Links/FastPowerMeter`|[HpePowerMeter](../ilo6_hpe_resourcedefns110/#hpepowermeter)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Processor](../ilo6_other_resourcedefns110/#processor)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Role](../ilo6_other_resourcedefns110/#role)|
...
|Link Name|Destination type
|---|---|
|`securebootdatabases`|Collection of [SecureBootDatabase](../ilo6_other_resourcedefns110/#securebootdatabasecollection)|
...
|Link Name|Destination type
|---|---|
|`Certificates`|Collection of [Certificate](../ilo6_other_resourcedefns110/#certificatecollection)|
|`Signatures`|Collection of [Signature](../ilo6_other_resourcedefns110/#signaturecollection)|
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/systems/{item}/secureboot/securebootdatabases`|GET POST |

### Links to other Resources

|Link Name|Destination type
|---|---|
|`Members[]`|[SecureBootDatabase](../ilo6_other_resourcedefns110/#securebootdatabase)|
...
|Link Name|Destination type
|---|---|
|`Oem/Hpe/Links/MySession`|[Session](../ilo6_other_resourcedefns110/#session)|
|`Members[]`|[Session](../ilo6_other_resourcedefns110/#session)|
...
|Link Name|Destination type
|---|---|
|`Sessions`|Collection of [Session](../ilo6_other_resourcedefns110/#sessioncollection)|
...
`@odata.type: "#Signature.v1_0_0.Signature"`
...
Member of [Signature.v1\_0\_0.Signature](#signature)
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Signature](../ilo6_other_resourcedefns110/#signature)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[SoftwareInventory](../ilo6_other_resourcedefns110/#softwareinventory)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Task](../ilo6_other_resourcedefns110/#task)|
...
|Link Name|Destination type
|---|---|
|`Tasks`|Collection of [Task](../ilo6_other_resourcedefns110/#taskcollection)|
...
|Link Name|Destination type
|---|---|
|`MetricReports`|Collection of [MetricReport](../ilo6_other_resourcedefns110/#metricreportcollection)|
|`MetricReportDefinitions`|Collection of [MetricDefinition](../ilo6_other_resourcedefns110/#metricdefinitioncollection)|
|`Triggers`|Collection of [Triggers](../ilo6_other_resourcedefns110/#triggerscollection)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[Triggers](../ilo6_other_resourcedefns110/#triggers)|
...
|Link Name|Destination type
|---|---|
|`Oem/Hpe/InstallSets`|Collection of [HpeComponentInstallSet](../ilo6_hpe_resourcedefns110/#hpecomponentinstallsetcollection)|
|`Oem/Hpe/ComponentRepository`|Collection of [HpeComponent](../ilo6_hpe_resourcedefns110/#hpecomponentcollection)|
|`FirmwareInventory`|Collection of [SoftwareInventory](../ilo6_other_resourcedefns110/#softwareinventorycollection)|
|`SoftwareInventory`|Collection of [SoftwareInventory](../ilo6_other_resourcedefns110/#softwareinventorycollection)|
|`Oem/Hpe/UpdateTaskQueue`|Collection of [HpeComponentUpdateTask](../ilo6_hpe_resourcedefns110/#hpecomponentupdatetaskqueuecollection)|
...
|Link Name|Destination type
|---|---|
|`Members[]`|[VirtualMedia](../ilo6_other_resourcedefns110/#virtualmedia)|
