---
seo:
  title: HPE iLO 6 v1.05 reference documents
disableLastModified: true
toc:
   enable: false
---

# HPE iLO 6 v1.05 reference documents overview

HPE iLO Redfish reference documents consist of three documents bound to a specific iLO firmware version:

- [Resource map](/docs/redfishservices/ilos/ilo6/ilo6_105/ilo6_resmap105/)
- Resource definitions (i.e. [ServiceRoot](/docs/redfishservices/ilos/ilo6/ilo6_105/ilo6_serviceroot_resourcedefns105/))
- [Error messages](/docs/redfishservices/ilos/ilo6/ilo6_105/ilo6_msgregs105/)
