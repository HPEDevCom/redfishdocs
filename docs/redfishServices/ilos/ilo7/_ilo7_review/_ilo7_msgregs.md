...
This section is a reference for the defined message registry entries in HPE iLO 7 version 1.11. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
### iLOResourceEvents.7.0.AdapterConfigurationChange
...
### iLOResourceEvents.7.0.AggregateHealthStatusChange
...
### iLOResourceEvents.7.0.AutoShutdownCancelled
...
### iLOResourceEvents.7.0.AutoShutdownInitiated
...
### iLOResourceEvents.7.0.BIOSSafeModeEngaged
...
### iLOResourceEvents.7.0.BIOSSafeModeExit
...
### iLOResourceEvents.7.0.ComputeOpsManagerConnected
...
### iLOResourceEvents.7.0.ComputeOpsManagerConnectionFailed
...
### iLOResourceEvents.7.0.ComputeOpsManagerConnectionInProgress
...
### iLOResourceEvents.7.0.ComputeOpsManagerConnectionInitiated
...
### iLOResourceEvents.7.0.ComputeOpsManagerConnectionNotEnabled
...
### iLOResourceEvents.7.0.ComputeOpsManagerDisabledByFactoryDefaults
...
### iLOResourceEvents.7.0.ComputeOpsManagerDisabledBySecureErase
...
### iLOResourceEvents.7.0.ComputeOpsManagerDisabledByUser
...
### iLOResourceEvents.7.0.DeviceDiscoveryStatusV2
...
### iLOResourceEvents.7.0.DriveInserted2
...
### iLOResourceEvents.7.0.DriveRemoved2
...
### iLOResourceEvents.7.0.DrvArrLogDrvErasing
...
### iLOResourceEvents.7.0.DrvArrLogDrvExpanding
...
### iLOResourceEvents.7.0.DrvArrLogDrvNewLogDrvKeyRekeyRequestReceived
...
### iLOResourceEvents.7.0.DrvArrLogDrvPredictiveSpareRebuildReady
...
### iLOResourceEvents.7.0.DrvArrLogDrvQueuedForExpansion
...
### iLOResourceEvents.7.0.DrvArrLogDrvRapidParityInitializationInProgress
...
### iLOResourceEvents.7.0.DrvArrLogDrvRapidParityInitializationPending
...
### iLOResourceEvents.7.0.DrvArrLogDrvReadyRebuild
...
### iLOResourceEvents.7.0.DrvArrLogDrvRebuilding
...
### iLOResourceEvents.7.0.DrvArrLogDrvRekeyInProgress
...
### iLOResourceEvents.7.0.DrvArrLogDrvUnconfigured
...
### iLOResourceEvents.7.0.DrvArrLogDrvUnencryptedToEncryptedTransformationInProgress
...
### iLOResourceEvents.7.0.DrvArrLogDrvUnencryptedToEncryptedTransformationNotStarted
...
### iLOResourceEvents.7.0.DrvArrPhysDrvEraseDone
...
### iLOResourceEvents.7.0.DrvArrPhysDrvEraseQueued
...
### iLOResourceEvents.7.0.DrvArrPhysDrvErasing
...
### iLOResourceEvents.7.0.DrvArrSpareDriveActive
...
### iLOResourceEvents.7.0.DrvArrSpareDriveBuilding
...
### iLOResourceEvents.7.0.DrvArrSpareDriveInactive
...
### iLOResourceEvents.7.0.DrvArrayAccBoardTempDisabled_ExpandInProgress
...
### iLOResourceEvents.7.0.DrvArrayAccBoardTempDisabled_SnapshotInProgress
...
### iLOResourceEvents.7.0.FanInserted
...
### iLOResourceEvents.7.0.FanRemoved
...
### iLOResourceEvents.7.0.FansHealthOk
...
### iLOResourceEvents.7.0.FirmwareFlashStatusChanged
...
### iLOResourceEvents.7.0.FirmwareIntegrityScanComplete
...
### iLOResourceEvents.7.0.FirmwareRecoveryRequest
...
### iLOResourceEvents.7.0.IndicatorLEDStateChanged
...
### iLOResourceEvents.7.0.IntelligentDiagnosticsEnabled
...
### iLOResourceEvents.7.0.IntelligentDiagnosticsExit
...
### iLOResourceEvents.7.0.IntrusionHWInstalled
...
### iLOResourceEvents.7.0.IntrusionHWRemoved
...
### iLOResourceEvents.7.0.LiquidCoolingHealthOk
...
### iLOResourceEvents.7.0.MemoryHealthOk
...
### iLOResourceEvents.7.0.NetworkHealthOk
...
### iLOResourceEvents.7.0.PowerSuppliesHealthOk
...
### iLOResourceEvents.7.0.PowerSupplyInserted
...
### iLOResourceEvents.7.0.PowerSupplyRemoved
...
### iLOResourceEvents.7.0.ProcessorsHealthOk
...
### iLOResourceEvents.7.0.RemoteSupportRegistrationComplete
...
### iLOResourceEvents.7.0.RemoteSupportUnregistrationComplete
...
### iLOResourceEvents.7.0.SecurityStateChange
...
### iLOResourceEvents.7.0.ServerPostComplete
...
### iLOResourceEvents.7.0.ServerPostDiscoveryComplete
...
### iLOResourceEvents.7.0.ServerPoweredOff
...
### iLOResourceEvents.7.0.ServerPoweredOn
...
### iLOResourceEvents.7.0.ServerResetDetected
...
### iLOResourceEvents.7.0.SmartStorageBatteryHealthOk
...
### iLOResourceEvents.7.0.StorageHealthOk
...
### iLOResourceEvents.7.0.TemperatureHealthOk
...
### iLOResourceEvents.7.0.UpdateTaskStateChanged
...
### iLOResourceEvents.7.0.iLODriveComponentAdded
...
### iLOResourceEvents.7.0.iLORestServicesStarted
