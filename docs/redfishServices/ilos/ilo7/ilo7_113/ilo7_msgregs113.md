...
seo:
  title: iLO 7 v113 Error messages
markdown:
  toc:
    hide: false
    depth: 2
...
This section is a reference for the defined message registry entries in HPE iLO 7 version 1.13. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
