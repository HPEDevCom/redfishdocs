...
|---|---|
|`Oem/Hpe/appaccounts`|Collection of [HpeiLOAppAccount](ilo7_hpe_resourcedefns111/#hpeiloappaccountcollection)|
|`Accounts`|Collection of [ManagerAccount](ilo7_manager_resourcedefns111/#manageraccountcollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MessageRegistryFile](#messageregistryfile)|
...
|Uri|HTTP Allow|
|---|---|
|`/redfish/v1/chassis/{item}/thermalsubsystem`|GET |
