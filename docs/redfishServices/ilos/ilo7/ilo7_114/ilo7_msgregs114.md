---
seo:
  title: iLO 7 v114 Error messages
markdown:
  toc:
    hide: false
    depth: 2
...
# Response message definitions of iLO 7 v1.14

This section is a reference for the defined message registry entries in HPE iLO 7 version 1.14. Redfish responses are discussed in the [error responses](/docs/concepts/errorresponses.md) section.
...
|Severity|Critical|
|Resolution|Obtain the certificate whose validity is within the ilo time|
...
### iLOResourceEvents.7.1.AdapterConfigurationChange
...
### iLOResourceEvents.7.1.AggregateHealthStatusChange
...
### iLOResourceEvents.7.1.AutoShutdownCancelled
...
### iLOResourceEvents.7.1.AutoShutdownInitiated
...
### iLOResourceEvents.7.1.BIOSSafeModeEngaged
...
### iLOResourceEvents.7.1.BIOSSafeModeExit
...
### iLOResourceEvents.7.1.ComputeOpsManagerConnected
...
### iLOResourceEvents.7.1.ComputeOpsManagerConnectionFailed
...
### iLOResourceEvents.7.1.ComputeOpsManagerConnectionInProgress
...
### iLOResourceEvents.7.1.ComputeOpsManagerConnectionInitiated
...
### iLOResourceEvents.7.1.ComputeOpsManagerConnectionNotEnabled
...
### iLOResourceEvents.7.1.ComputeOpsManagerDisabledByFactoryDefaults
...
### iLOResourceEvents.7.1.ComputeOpsManagerDisabledBySecureErase
...
### iLOResourceEvents.7.1.ComputeOpsManagerDisabledByUser
...
### iLOResourceEvents.7.1.DeviceDiscoveryStatusV2
...
### iLOResourceEvents.7.1.DriveInserted2
...
### iLOResourceEvents.7.1.DriveRemoved2
...
### iLOResourceEvents.7.1.DrvArrLogDrvErasing
...
### iLOResourceEvents.7.1.DrvArrLogDrvExpanding
...
### iLOResourceEvents.7.1.DrvArrLogDrvNewLogDrvKeyRekeyRequestReceived
...
### iLOResourceEvents.7.1.DrvArrLogDrvPredictiveSpareRebuildReady
...
### iLOResourceEvents.7.1.DrvArrLogDrvQueuedForExpansion
...
### iLOResourceEvents.7.1.DrvArrLogDrvRapidParityInitializationInProgress
...
### iLOResourceEvents.7.1.DrvArrLogDrvRapidParityInitializationPending
...
### iLOResourceEvents.7.1.DrvArrLogDrvReadyRebuild
...
### iLOResourceEvents.7.1.DrvArrLogDrvRebuilding
...
### iLOResourceEvents.7.1.DrvArrLogDrvRekeyInProgress
...
### iLOResourceEvents.7.1.DrvArrLogDrvUnconfigured
...
### iLOResourceEvents.7.1.DrvArrLogDrvUnencryptedToEncryptedTransformationInProgress
...
### iLOResourceEvents.7.1.DrvArrLogDrvUnencryptedToEncryptedTransformationNotStarted
...
### iLOResourceEvents.7.1.DrvArrPhysDrvEraseDone
...
### iLOResourceEvents.7.1.DrvArrPhysDrvEraseQueued
...
### iLOResourceEvents.7.1.DrvArrPhysDrvErasing
...
### iLOResourceEvents.7.1.DrvArrSpareDriveActive
...
### iLOResourceEvents.7.1.DrvArrSpareDriveBuilding
...
### iLOResourceEvents.7.1.DrvArrSpareDriveInactive
...
### iLOResourceEvents.7.1.DrvArrayAccBoardTempDisabled_ExpandInProgress
...
### iLOResourceEvents.7.1.DrvArrayAccBoardTempDisabled_SnapshotInProgress
...
### iLOResourceEvents.7.1.FanInserted
...
### iLOResourceEvents.7.1.FanRemoved
...
### iLOResourceEvents.7.1.FansHealthOk
...
### iLOResourceEvents.7.1.FirmwareFlashStatusChanged
...
### iLOResourceEvents.7.1.FirmwareIntegrityScanComplete
...
### iLOResourceEvents.7.1.FirmwareRecoveryRequest
...
### iLOResourceEvents.7.1.IndicatorLEDStateChanged
...
### iLOResourceEvents.7.1.IntelligentDiagnosticsEnabled
...
### iLOResourceEvents.7.1.IntelligentDiagnosticsExit
...
### iLOResourceEvents.7.1.IntrusionHWInstalled
...
### iLOResourceEvents.7.1.IntrusionHWRemoved
...
### iLOResourceEvents.7.1.LiquidCoolingHealthOk
...
### iLOResourceEvents.7.1.MemoryHealthOk
...
### iLOResourceEvents.7.1.NetworkHealthOk
...
### iLOResourceEvents.7.1.PowerSuppliesHealthOk
...
### iLOResourceEvents.7.1.PowerSupplyInserted
...
### iLOResourceEvents.7.1.PowerSupplyRemoved
...
### iLOResourceEvents.7.1.ProcessorsHealthOk
...
### iLOResourceEvents.7.1.RemoteSupportRegistrationComplete
...
### iLOResourceEvents.7.1.RemoteSupportUnregistrationComplete
...
### iLOResourceEvents.7.1.SecurityStateChange
...
### iLOResourceEvents.7.1.ServerPostComplete
...
### iLOResourceEvents.7.1.ServerPostDiscoveryComplete
...
### iLOResourceEvents.7.1.ServerPoweredOff
...
### iLOResourceEvents.7.1.ServerPoweredOn
...
### iLOResourceEvents.7.1.ServerResetDetected
...
### iLOResourceEvents.7.1.SmartStorageBatteryHealthOk
...
### iLOResourceEvents.7.1.StorageHealthOk
...
### iLOResourceEvents.7.1.TemperatureHealthOk
...
### iLOResourceEvents.7.1.UpdateTaskStateChanged
...
### iLOResourceEvents.7.1.iLODriveComponentAdded
...
### iLOResourceEvents.7.1.iLORestServicesStarted
...
### iLOSecurityEvents.7.1.AccessPanelStatusAtIgnore
...
### iLOSecurityEvents.7.1.AccessPanelStatusAtOK
...
### iLOSecurityEvents.7.1.AccessPanelStatusAtRisk
...
### iLOSecurityEvents.7.1.ComponentIntegrityAtIgnore

The Component Integrity setting on security dashboard is Disabled. The parameter risk is ignored.

| | |
|:---|:---|
|Message Format|"The  Component Integrity status on security dashboard is %1. State is %2. Ignore flag is %3"|
|Severity|Warning|
|Resolution|Enable the Component Integrity setting in iLO|

### iLOSecurityEvents.7.1.ComponentIntegrityAtOK

The  Component Integrity on security dashboard is OK.
...
### iLOSecurityEvents.7.1.ComponentIntegrityAtRisk

The Component Integrity setting on security dashboard is Disabled.
...
### iLOSecurityEvents.7.1.DefaultSSLCertificateAtIgnore
...
### iLOSecurityEvents.7.1.DefaultSSLCertificateAtOK
...
### iLOSecurityEvents.7.1.DefaultSSLCertificateAtRisk
...
### iLOSecurityEvents.7.1.GlobalComponentIntegrityAtIgnore
...
### iLOSecurityEvents.7.1.GlobalComponentIntegrityAtOK
...
### iLOSecurityEvents.7.1.GlobalComponentIntegrityAtRisk
...
### iLOSecurityEvents.7.1.IPMIOverLANAtIgnore
...
### iLOSecurityEvents.7.1.IPMIOverLANAtOK
...
### iLOSecurityEvents.7.1.IPMIOverLANAtRisk
...
### iLOSecurityEvents.7.1.LastFWScanAtIgnore
...
### iLOSecurityEvents.7.1.LastFWScanAtOK
...
### iLOSecurityEvents.7.1.LastFWScanAtRisk
...
### iLOSecurityEvents.7.1.LogAuthFailureAtIgnore
...
### iLOSecurityEvents.7.1.LogAuthFailureAtOK
...
### iLOSecurityEvents.7.1.LogAuthFailureAtRisk
...
### iLOSecurityEvents.7.1.MinPasswordLengthAtIgnore
...
### iLOSecurityEvents.7.1.MinPasswordLengthAtOK
...
### iLOSecurityEvents.7.1.MinPasswordLengthAtRisk
...
### iLOSecurityEvents.7.1.OverallSecAtIgnore
...
### iLOSecurityEvents.7.1.OverallSecAtOK
...
### iLOSecurityEvents.7.1.OverallSecAtRisk
...
### iLOSecurityEvents.7.1.PasswordComplexityAtIgnore
...
### iLOSecurityEvents.7.1.PasswordComplexityAtOK
...
### iLOSecurityEvents.7.1.PasswordComplexityAtRisk
...
### iLOSecurityEvents.7.1.SNMPv1AtIgnore
...
### iLOSecurityEvents.7.1.SNMPv1AtOK
...
### iLOSecurityEvents.7.1.SNMPv1AtRisk
...
### iLOSecurityEvents.7.1.SecOverrideSwitchAtIgnore
...
### iLOSecurityEvents.7.1.SecOverrideSwitchAtOK
...
### iLOSecurityEvents.7.1.SecOverrideSwitchAtRisk
...
### iLOSecurityEvents.7.1.SecureBootAtIgnore
...
### iLOSecurityEvents.7.1.SecureBootAtOK
...
### iLOSecurityEvents.7.1.SecureBootAtRisk
