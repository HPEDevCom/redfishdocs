...
# Other resource definitions of iLO 7 v1.14
...
|---|---|
|`Oem/Hpe/appaccounts`|Collection of [HpeiLOAppAccount](ilo7_hpe_resourcedefns114/#hpeiloappaccountcollection)|
|`Accounts`|Collection of [ManagerAccount](ilo7_manager_resourcedefns114/#manageraccountcollection)
...
This property shall contain a reference to a resource of type HpeiLOAppAccount.
AppAccounts is a link (`"@odata.id": URI`) to another resource.
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[BootOption](ilo7_other_resourcedefns114/#bootoption)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Certificate](ilo7_other_resourcedefns114/#certificate)|
...
|Link Name|Destination type|
|---|---|
|`Links/CertificateLocations`|[CertificateLocations](ilo7_other_resourcedefns114/#certificatelocations)|
...
Member of [ComponentIntegrity.v1\_2\_3.ComponentIntegrity](#componentintegrity)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[ComponentIntegrity](ilo7_other_resourcedefns114/#componentintegrity)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[EventDestination](ilo7_other_resourcedefns114/#eventdestination)|
...
|Link Name|Destination type|
|---|---|
|`Subscriptions`|Collection of [EventDestination](ilo7_other_resourcedefns114/#eventdestinationcollection)|
|`Oem/Hpe/CACertificates`|Collection of [HpeCertificate](ilo7_hpe_resourcedefns114/#hpecertificatecollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Fabric](ilo7_other_resourcedefns114/#fabric)|
...
|Link Name|Destination type|
|---|---|
|`Assembly`|[Assembly](ilo7_other_resourcedefns114/#assembly)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Fan](ilo7_other_resourcedefns114/#fan)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[HostInterface](ilo7_other_resourcedefns114/#hostinterface)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[JsonSchemaFile](ilo7_other_resourcedefns114/#jsonschemafile)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Key](ilo7_other_resourcedefns114/#key)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[LogEntry](ilo7_other_resourcedefns114/#logentry)|
...
|Link Name|Destination type|
|---|---|
|`Entries`|Collection of [LogEntry](ilo7_other_resourcedefns114/#logentrycollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[LogService](ilo7_other_resourcedefns114/#logservice)|
...
|Link Name|Destination type|
|---|---|
|`memorymetrics`|[MemoryMetrics](ilo7_other_resourcedefns114/#memorymetrics)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MemoryChunks](ilo7_other_resourcedefns114/#memorychunks)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Memory](ilo7_other_resourcedefns114/#memory)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MemoryDomain](ilo7_other_resourcedefns114/#memorydomain)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MessageRegistryFile](ilo7_other_resourcedefns114/#messageregistryfile)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricDefinition](ilo7_other_resourcedefns114/#metricdefinition)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricReport](ilo7_other_resourcedefns114/#metricreport)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[MetricReportDefinition](ilo7_other_resourcedefns114/#metricreportdefinition)|
...
|Link Name|Destination type|
|---|---|
|`PCIeFunctions`|[PCIeFunction](ilo7_other_resourcedefns114/#pciefunction)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[PCIeDevice](ilo7_other_resourcedefns114/#pciedevice)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[PCIeFunction](ilo7_other_resourcedefns114/#pciefunction)|
...
|Link Name|Destination type|
|---|---|
|`settings`|[Port](ilo7_other_resourcedefns114/#port)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Port](ilo7_other_resourcedefns114/#port)|
...
|Link Name|Destination type|
|---|---|
|`Oem/Hpe/Links/PowerMeter`|[HpePowerMeter](ilo7_hpe_resourcedefns114/#hpepowermeter)|
|`Redundancy[]/RedundancySet[]`|[Power](ilo7_other_resourcedefns114/#power)|
|`Oem/Hpe/Links/FastPowerMeter`|[HpePowerMeter](ilo7_hpe_resourcedefns114/#hpepowermeter)|
...
|Link Name|Destination type|
|---|---|
|`environmentmetrics`|[EnvironmentMetrics](ilo7_other_resourcedefns114/#environmentmetrics)|
|`processormetrics`|[ProcessorMetrics](ilo7_other_resourcedefns114/#processormetrics)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Processor](ilo7_other_resourcedefns114/#processor)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Pump](ilo7_other_resourcedefns114/#pump)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Role](ilo7_other_resourcedefns114/#role)|
...
|Link Name|Destination type|
|---|---|
|`securebootdatabases`|Collection of [SecureBootDatabase](ilo7_other_resourcedefns114/#securebootdatabasecollection)|
...
|Link Name|Destination type|
|---|---|
|`Certificates`|Collection of [Certificate](ilo7_other_resourcedefns114/#certificatecollection)|
|`Signatures`|Collection of [Signature](ilo7_other_resourcedefns114/#signaturecollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[SecureBootDatabase](ilo7_other_resourcedefns114/#securebootdatabase)|
...
Member of [Sensor.v1\_10\_0.Sensor](#sensor)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Sensor](ilo7_other_resourcedefns114/#sensor)|
...
|Link Name|Destination type|
|---|---|
|`Oem/Hpe/Links/MySession`|[Session](ilo7_other_resourcedefns114/#session)|
|`Members[]`|[Session](ilo7_other_resourcedefns114/#session)|
...
|Link Name|Destination type|
|---|---|
|`Sessions`|Collection of [Session](ilo7_other_resourcedefns114/#sessioncollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Signature](ilo7_other_resourcedefns114/#signature)|
...
Member of [SoftwareInventory.v1\_3\_0.SoftwareInventory](#softwareinventory)
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[SoftwareInventory](ilo7_other_resourcedefns114/#softwareinventory)|
...
|Link Name|Destination type|
|---|---|
|`ports`|Collection of [Port](ilo7_other_resourcedefns114/#portcollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Task](ilo7_other_resourcedefns114/#task)|
...
|Link Name|Destination type|
|---|---|
|`Tasks`|Collection of [Task](ilo7_other_resourcedefns114/#taskcollection)|
...
|Link Name|Destination type|
|---|---|
|`MetricReports`|Collection of [MetricReport](ilo7_other_resourcedefns114/#metricreportcollection)|
|`MetricReportDefinitions`|Collection of [MetricDefinition](ilo7_other_resourcedefns114/#metricdefinitioncollection)|
|`Triggers`|Collection of [Triggers](ilo7_other_resourcedefns114/#triggerscollection)|
...
|Link Name|Destination type|
|---|---|
|`Fans`|Collection of [Fan](ilo7_other_resourcedefns114/#fancollection)|
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[Triggers](ilo7_other_resourcedefns114/#triggers)|
...
|`RunningSoftwareInventory`|Collection of [HpeiLORunningSoftwareInventory](ilo7_hpe_resourcedefns114/#hpeilorunningsoftwareinventorycollection)|
|`FirmwareInventory`|Collection of [SoftwareInventory](ilo7_other_resourcedefns114/#softwareinventorycollection)|
|`Oem/Hpe/InstallSets`|Collection of [HpeComponentInstallSet](ilo7_hpe_resourcedefns114/#hpecomponentinstallsetcollection)|
|`Oem/Hpe/ComponentRepository`|Collection of [HpeComponent](ilo7_hpe_resourcedefns114/#hpecomponentcollection)|
|`SoftwareInventory`|Collection of [SoftwareInventory](ilo7_other_resourcedefns114/#softwareinventorycollection)|
...
Link to the Running Software.
RunningSoftwareInventory is a link (`"@odata.id": URI`) to another resource.
...
|Link Name|Destination type|
|---|---|
|`Members[]`|[VirtualMedia](ilo7_other_resourcedefns114/#virtualmedia)|
